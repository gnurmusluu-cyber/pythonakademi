...
def egitim_ekrani(u, mufredat, msgs, emotions_module, ranks_module, ilerleme_fonksiyonu, normalize_fonksiyonu, supabase):
    ...
    st.markdown('''
        ...
        /* PITO KOKPİT GÖRSELİ (80px - BÜYÜTÜLDÜ) */
        .hud-pito-gif img {
    ...
    with cl:
        # NAVİGASYON: İsim, Geçmiş Egzersizler ve Çıkış
        ...
        with c_rev:
            if st.button("🔍 Geçmiş egzersizler", help="Daha önceki çözümlerini incele", use_container_width=True, key="rev_btn_master"):
                st.session_state.in_review = True; st.rerun()
        with c_exit:
            if st.button("🚪 Çıkış", help="Oturumu güvenli bir şekilde kapat", use_container_width=True, key="exit_btn_master"):
