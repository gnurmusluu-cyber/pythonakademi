...
def egitim_ekrani(u, mufredat, msgs, emotions_module, ranks_module, ilerleme_fonksiyonu, normalize_fonksiyonu, supabase):
    ...
    # Sayı her değiştiğinde tarayıcının animasyonu baştan oynatması için gereklidir.
    e_count = st.session_state.get('error_count', 0)
    anim_toggle = "A" if e_count % 2 == 0 else "B"
    
    # --- 0. SİBER-GÖRSEL ZIRH (GÖRÜNÜRLÜK VE 75PX MÜHRÜ) ---
    st.markdown(f'''
        <style>
        header[data-testid="stHeader"], [data-testid="stDecoration"], footer {{ display: none !important; }}
        .stApp {{ background-color: #0e1117 !important; }}

        /* ANA İÇERİK BOŞLUĞU (BAŞLIK HUD ALTINDA KALMAZ) */
        ...
        /* --- DOUBLE PULSE ANIMATION (SİBER-VURGU) --- */
        ...
        @media (max-width: 768px) {{
            ...
            .hud-pito-gif img {{ width: 65px !important; height: 65px !important; margin-right: 0; margin-bottom: 5px; }}
