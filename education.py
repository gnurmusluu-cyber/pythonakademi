...
def egitim_ekrani(u, mufredat, msgs, emotions_module, ranks_module, ilerleme_fonksiyonu, normalize_fonksiyonu, supabase, inceleme_modu=False):
    # --- 0. SİBER-HUD VE ELECTRIC BLUE CSS ---
    st.markdown('''
        <style>
        ...
        .cyber-hud {
            ...
            z-index: 99999; padding: 12px 25px;
        ...
        /* HUD altındaki içeriğin kaybolmaması için padding */
        ...
        .academy-header {
            ...
            text-shadow: 0 0 20px rgba(0, 229, 255, 0.4); margin-bottom: 15px;
        }
        </style>
    ...
    with cl:
        ...
        if not st.session_state.cevap_dogru and st.session_state.error_count < 4:
            ...
            user_code = st.text_area("Siber-Editor", value=egz['sablon'], height=180, key=f"final_hud_{egz['id']}_{st.session_state.reset_trigger}", label_visibility="collapsed")
