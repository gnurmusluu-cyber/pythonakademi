...
training_data = [
    ...
    {"module_title": "6. Fonksiyonlar ve Gelişmiş Veriler", "exercises": [{"msg": "**Fonksiyonlar**, tekrar kullanılabilen kod paketleridir. 'def' ile tanımlanır.", "task": "___ f(): print('X')", "check": lambda c, o: "def" in c, "solution": "def f(): print('X')"}, {"msg": "**Tuple (Demet)**, listeye benzer ama **değiştirilemez**. () kullanılır.", "task": "t = (___, 2)", "check": lambda c, o: "1" in c, "solution": "t = (1, 2)\nprint(t)"}, {"msg": "**Sözlükler**, 'Anahtar: Değer' çifti tutar. 'ad' anahtarına 'Pito' ata.", "task": "d = {'ad': '___'}", "check": lambda c, o: "Pito" in c, "solution": "d = {'ad': 'Pito'}\nprint(d['ad'])"}, {"msg": "keys() metodu sözlükteki anahtar başlıklarını sunar.", "task": "d={'a':1}\nprint(d.___())", "check": lambda c, o: "keys" in c, "solution": "d={'a':1}\nprint(d.keys())"}, {"msg": "**Set (Küme)**, benzersiz koleksiyondur. {1, 2, 1} ile oluştur.", "task": "s = {1, 2, ___}", "check": lambda c, o: "1" in c, "solution": "s = {1, 2, 1}\nprint(s)"}]},
    {"module_title": "7. OOP (Sınıf ve Metotlar)", "exercises": [
        {"msg": "**Sınıflar (Class)**, nesne taslaklarıdır. Sınıf oluştururken **class** (küçük harf!) kullanılır.", "task": "___ Robot: pass", "check": lambda c, o: "class" in c, "solution": "class Robot: pass"},
        {"msg": "**Nesneler**, sınıftan üretilen örneklerdir. R sınıfından 'p' nesnesi üret.", "task": "class R: pass\np = ___()", "check": lambda c, o: "R()" in c, "solution": "class R: pass\np = R()"},
        ...
        {"msg": "**Metotlar**, sınıf içi fonksiyonlardır. Metotların ilk parametresi her zaman **self** olmalıdır. Hadi dene: Robota **ses** adında bir metot ekle ve içine print('Bip!') yaz.", "task": "class R:\n def ___(self):\n  print('Bip!')", "check": lambda c, o: "ses" in c, "solution": "class R:\n def ses(self):\n  print('Bip!')"},
        {"msg": "Metotları çalıştırmak için **nesne_adi.metot_adi()** kullanılır. 'r' üzerinden 's' metodunu çağır.", "task": "class R: def s(self): print('X')\nr=R()\nr.___()", "check": lambda c, o: "s()" in c, "solution": "class R: def s(self): print('X')\nr=R()\nr.s()"}
    ]},
    {"module_title": "8. Dosya Yönetimi", "exercises": [
        ...
        {"msg": "**read()** metodu içeriği bütünüyle getirir.", "task": "f = open('t.txt', 'r'); print(f.___()); f.close()", "check": lambda c, o: "read" in c, "solution": "f = open('t.txt', 'w'); f.write('Pito'); f.close(); f = open('t.txt', 'r'); print(f.read()); f.close()"},
...
with col_main:
    ...
    # İNDEX TABANLI KONTROL (API HATASINI ÖNLER)
