...
# --- 4. LİDERLİK TABLOSU (MÜHÜRLÜ - EN ÜSTTE) ---
...
def show_pito_img(width=180):
    ...
    if os.path.exists(img_path): st.image(img_path, width=width)
...
with col_app:
        ...
        if in_no:
            if not in_no.isdigit(): st.error("⚠️ Sadece rakam giriniz!")
                ...
                if not user_data.empty:
                    ...
                    st.success("🌟 Seni henüz tanımıyorum. Python macerasına katılmak için kendini tanıt!")
    ...
    training_data = [
        {"module_title": "1. İletişim: print() ve Metin Dünyası", "exercises": [
            {"msg": "**Pito'nun Notu:** Python'ın dünyayla konuşma yolu `print()` fonksiyonudur. Ekrana yazacağın metinleri mutlaka tırnak (' ') içine almalısın. Tırnaklar Python'a 'buradaki ifadeyi olduğu gibi yansıt' der.\n\n**GÖREV:** Editor içine tam olarak **'Merhaba Pito'** metnini tırnaklar içerisinde yaz ve kontrol et!", "task": "print('___')", "check": lambda c, o, i: "Merhaba Pito" in o, "solution": "print('Merhaba Pito')", "hint": "Metnin hem başına hem sonuna tek (') veya çift (\") tırnak koy."},
            {"msg": "**Pito'un Notu:** Sayılar (Integer), metinlerden farklıdır; tırnak gerektirmezler. Eğer bir sayıya tırnak koyarsan Python onu sayı değil, bir metin olarak görür ve üzerinde matematik yapamaz.\n\n**GÖREV:** Boşluğa tırnak kullanmadan sadece **100** sayısını yaz. Bu sayede Python onun bir sayı olduğunu anlayacaktır.", "task": "print(___)", "check": lambda c, o, i: "100" in o, "solution": "print(100)", "hint": "Rakamları tırnaksız yazmalısın."},
            {"msg": "**Pito'un Notu:** Virgül (`,`) farklı veri tiplerini aynı satırda birleştirirken otomatik bir boşluk koyar. Bu, değişkenleri ve mesajları birleştirmek için en profesyonel yoldur.\n\n**GÖREV:** 'Puan:' metni ile **100** sayısını yan yana basmak için virgülden sonraki boşluğa sadece **100** yaz.", "task": "print('Puan:', ___)", "check": lambda c, o, i: "100" in o, "solution": "print('Puan:', 100)", "hint": "Virgülden sonra sadece sayısal değeri yaz."},
            {"msg": "**Pito'un Notu:** `#` işareti Python'a 'Bu satırı görmezden gel' demektir (Yorum Satırı). Sadece biz yazılımcıların not alması içindir; kodun çalışmasını asla etkilemez.\n\n**GÖREV:** Satırın en başına **#** işaretini koyarak bu satırı etkisiz bir nota dönüştür.", "task": "___ bu bir nottur", "check": lambda c, o, i: "#" in c, "solution": "# bu bir nottur", "hint": "Diyez işaretini satırın başına yerleştir."},
        ...
        {"module_title": "2. Hafıza: Değişkenler ve Atama", "exercises": [
            {"msg": "**Pito'un Notu:** Değişkenler bellekteki kutulardır. `=` işareti bir 'atama operatörü'dür ve sağdaki değeri soldaki kutunun içine koyar.\n\n**GÖREV:** `yas` ismindeki hafıza kutusuna sayısal olarak **15** değerini ata ve Python'ın onu saklamasını sağla.", "task": "yas = ___", "check": lambda c, o, i: "15" in str(i.get('yas', '')), "solution": "yas = 15", "hint": "Eşittir işaretinden sonra sadece 15 yaz."},
            {"msg": "**Pito'un Notu:** Metin verilerini saklarken tırnak şarttır. İsimlerde boşluk kullanamazsın ve rakamla başlayamazsın.\n\n**GÖREV:** `isim` değişkenine **'Pito'** metnini ata. Tırnak kullanmayı unutma!", "task": "isim = '___'", "check": lambda c, o, i: "Pito" in str(i.get('isim', '')), "solution": "isim = 'Pito'", "hint": "Tırnaklar arasına Pito yaz."},
            {"msg": "**Pito'un Notu:** `input()` programı durdurur ve kullanıcıdan bir bilgi bekler. Python bu bilgiyi her zaman 'String' (metin) olarak algılar.\n\n**GÖREV:** Kullanıcıdan adını almak için boşluğa veri alma fonksiyonu olan **input** yaz.", "task": "ad = ___('Adın: ')", "check": lambda c, o, i: "input" in c, "solution": "ad = input('Adın: ')", "hint": "input kelimesini kullan."},
            {"msg": "**Pito'un Notu:** Sayıları metne çevirmek için `str()` (Casting) fonksiyonunu kullanırız. Bu, metin birleştirme için hayati önem taşır.\n\n**GÖREV:** 10 sayısını metne çeviren **str** fonksiyonunu boşluğa yerleştir.", "task": "print(___(10))", "check": lambda c, o, i: "str" in c, "solution": "print(str(10))", "hint": "str fonksiyonunu yerleştir."},
            {"msg": "**Pito'un Notu:** Matematik yapabilmek için `input()` ile gelen metni `int()` ile tam sayıya çevirmelisin. Buna tip dönüşümü denir.\n\n**GÖREV:** Dış boşluğa **int**, içe **input** yazarak sayı girişi alan sistemi kur.", "task": "n = ___(___('S: '))", "check": lambda c, o, i: "int" in c and "input" in c, "solution": "n = int(input('S: '))", "hint": "int(input()) yapısını kur."}
        ]},
        {"module_title": "3. Karar Yapıları: If-Else Mantığı", "exercises": [
            {"msg": "**Konu:** Programların karar mekanizması `if` bloğuyla başlar. Eşitlik sorgusunda mutlaka `==` (çift eşittir) kullanmalısın.", "task": "if 10 ___ 10: print('OK')", "check": lambda c, o, i: "==" in c, "solution": "if 10 == 10:\n    print('OK')", "hint": "== koy."},
            {"msg": "**Konu:** `else:` bloğu, 'if' şartı sağlanmadığında devreye giren son çaredir.", "task": "if 5 > 10: pass\n___: print('Hata')", "check": lambda c, o, i: "else" in c, "solution": "if 5 > 10: pass\nelse:\n    print('Hata')", "hint": "else: yaz."},
            {"msg": "**Konu:** Birden fazla şartı denetlemek için `elif` kullanılır.", "task": "p = 60\nif p < 50: pass\n___ p > 50: print('G')", "check": lambda c, o, i: "elif" in c, "solution": "if p < 50: pass\nelif p > 50:\n    print('G')", "hint": "elif kullan."},
        ...
        {"module_title": "4. Otomasyon: For ve While Döngüleri", "exercises": [
            {"msg": "**Konu:** `range(5)` komutu 0'dan 4'e kadar sayı üretir. `for` bu sayılarda adım adım ilerler.", "task": "for i in ___(5): print(i)", "check": lambda c, o, i: "range" in c, "solution": "for i in range(5):\n    print(i)", "hint": "range yaz."},
            {"msg": "**Konu:** `while` döngüsü bir şart 'True' olduğu sürece çalışır.", "task": "i = 0\n___ i == 0: print('D'); i += 1", "check": lambda c, o, i: "while" in c, "solution": "i = 0\nwhile i == 0:\n    print('D')\n    i += 1", "hint": "while yaz."},
            {"msg": "**Konu:** `break` döngüyü anında sonlandırır.", "task": "for i in range(5):\n if i == 1: ___", "check": lambda c, o, i: "break" in c, "solution": "for i in range(5):\n    if i == 1: break\n    print(i)", "hint": "break kullan."},
            {"msg": "**Konu:** `continue` ise o anki adımı pas geçer.", "task": "for i in range(3):\n if i == 1: ___", "check": lambda c, o, i: "continue" in c, "solution": "for i in range(3):\n    if i == 1: continue\n    print(i)", "hint": "continue yaz."},
            {"msg": "**Konu:** Listelerde gezinmek için `in` kullanılır.", "task": "for x ___ ['A']: print(x)", "check": lambda c, o, i: "in" in c, "solution": "for x in ['A']:\n    print(x)", "hint": "in yaz."}
        ]},
        ...
        {"module_title": "6. Fonksiyonlar ve Sözlükler", "exercises": [
            ...
            {"msg": "**Sözlükler:** `{anahtar: değer}` çiftleriyle çalışır.", "task": "d = {'ad': '___'}", "check": lambda c, o, i: "Pito" in str(i.get('d', {})), "solution": "d = {'ad': 'Pito'}", "hint": "Pito yaz."},
            {"msg": "**Tuple:** İçeriği değiştirilemez! `()` ile kurulur.", "task": "t = (___, 2)", "check": lambda c, o, i: "1" in str(i.get('t', '')), "solution": "t = (1, 2)", "hint": "1 yaz."},
            ...
            {"msg": "**return:** Sonucu dışarıya fırlatır.", "task": "def f(): ___ 5", "check": lambda c, o, i: "return" in c, "solution": "def f():\n    return 5", "hint": "return kullan."}
        ]},
        {"module_title": "7. OOP: Nesne Tabanlı Dünya", "exercises": [
            {"msg": "**class:** Bir taslaktır. Ondan 'Nesneler' üretiriz.", "task": "___ Robot: pass", "check": lambda c, o, i: "class" in c, "solution": "class Robot:\n    pass", "hint": "class yaz."},
            {"msg": "Nesne `Robot()` ile üretilir.", "task": "class Robot: pass\nr = ___", "check": lambda c, o, i: "Robot" in str(i.get('r', '')), "solution": "class Robot: pass\nr = Robot()", "hint": "Robot() yaz."},
            {"msg": "Özellikler `.` yardımıyla atanır.", "task": "class R: pass\nr = R()\nr.___ = 'Mavi'", "check": lambda c, o, i: "renk" in c, "solution": "class R: pass\nr = R()\nr.renk = 'Mavi'", "hint": "renk yaz."},
            {"msg": "**self:** Nesnenin kendisidir. Metotlarda ilk sırada olmalıdır.", "task": "class R:\n def ses(___): print('Bip')", "check": lambda c, o, i: "self" in c, "solution": "class R:\n    def ses(self):\n        print('Bip')", "hint": "self yaz."},
        ...
        {"module_title": "8. Kalıcılık: Dosya Yönetimi", "exercises": [
            {"msg": "Kaydetmek için `open()` kullanılır. **'w'** yazma modudur.", "task": "f = ___('n.txt', '___')", "check": lambda c, o, i: "open" in c and "w" in c, "solution": "f = open('n.txt', 'w')", "hint": "open ve w yaz."},
            {"msg": "**.write():** İçeriği mühürler.", "task": "f = open('t.txt', 'w')\nf.___('X')", "check": lambda c, o, i: "write" in c, "solution": "f = open('t.txt', 'w')\nf.write('X')\nf.close()", "hint": "write yaz."},
    ...
    if not is_review_mode and st.session_state.fail_count < 4 and not st.session_state.exercise_passed:
        # ÖNEMLİ: input egzersizi ise editor altında text_input göster
        custom_input = ""
        if "input" in curr_ex['solution']:
            custom_input = st.text_input("📝 Buraya veri giriniz:", placeholder="Örn: 10 veya Pito", key=f"inp_{st.session_state.current_module}_{st.session_state.current_exercise}")
        ...
        if st.button("🔍 Kodumu Kontrol Et", use_container_width=True):
            ...
            elif "input" in curr_ex['solution'] and not custom_input: st.session_state.feedback_msg = "⚠️ Lütfen önce aşağıdaki kutuya bir veri gir!"; st.rerun()
            else:
                old_stdout, new_stdout = sys.stdout, StringIO(); sys.stdout = new_stdout
                try:
                    mock_env = {"print": print, "input": lambda x: custom_input or "10", "int": int, "str": str, "len": len, "open": open, "range": range, "s": 10, "L": [10, 20], "d":{'ad':'Pito'}, "t":(1,2), "Robot": lambda: None, "R": lambda: None, "yas": 15, "isim": "Pito", "ad": "Pito"}
                    ...
                    st.session_state.feedback_msg = f"❌ {st.session_state.fail_count}. Hatayı yaptın! 5 Puan Kaybettin. Kalan Ödül: {st.session_state.current_potential_score} Puan." if st.session_state.fail_count < 4 else "🌿 4 kez hata yaptığın için bu sorudan puan alamadın. Doğru çözümü yukarıdan inceleyip sonraki soruya geçelim."
                st.rerun()

    # --- 9. NAVİGASYON (TEMİZLEME MÜHÜRLÜ) ---
