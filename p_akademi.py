...
# --- 4. GİRİŞ EKRANI (TAM KOORDİNAT SENKRONU) ---
...
training_data = [
    {"module_title": "1. Giriş ve Çıktı", "exercises": [
        ...
        {"msg": "Sayıları ekrana yazdırırken **tırnak işareti kullanmayız.** Bu sayede Python onların 'sayı' olduğunu anlar. Ekrana 100 sayısını yazdır.", "task": "print(___)", "check": lambda c, o: "100" in o, "solution": "print(100)"},
        ...
        {"msg": "**# (Diyez)** işaretiyle başlayan satırlar Python tarafından okunmaz ve çalıştırılmaz. Buna 'Yorum Satırı' denir. Bir yorum satırı ekle.", "task": "___ Bu bir yorum", "check": lambda c, o: "#" in c, "solution": "# Bu bir yorumdur"},
    ...
    {"module_title": "2. Değişkenler", "exercises": [
        ...
        {"msg": "Kullanıcıdan gelen her veri metindir. Matematiksel işlem için int() ile tam sayıya çevirmelisin.", "task": "n = ___(___('S: '))\nprint(n + 1)", "check": lambda c, o: "int" in c, "solution": "n = int(input('10'))\nprint(n + 1)"}
    ]},
    ...
    {"module_title": "8. Dosya İşlemleri", "exercises": [
        {"msg": "open() ile dosya aç. 'w' kipi yazılabilir demektir.", "task": "dosya = ___('n.txt', '___')", "check": lambda c, o: "open" in c and "'w'" in c, "solution": "dosya = open('n.txt', 'w')\nprint('Açıldı.')"},
        {"msg": "write() metodu dosyaya bilgi yazar.", "task": "f = open('t.txt', 'w'); f.___('Pito'); f.close()", "check": lambda c, o: "write" in c, "solution": "f = open('t.txt', 'w'); f.write('Pito'); f.close()"},
        {"msg": "'r' kipi yalnızca okunabilir demektir.", "task": "f = open('t.txt', '___')", "check": lambda c, o: "'r'" in c, "solution": "f = open('t.txt', 'r'); f.close()"},
...
with col_main:
    ...
    if is_locked:
        ...
        # ÇÖZÜM ANAHTARI SİSTEMİ (Hata almayı önler)
