...
# SÜTUNLARI st.stop ÖNCESİNE ALIYORUZ (Liderlik Görünürlüğü İçin)
...
with col_app:
    ...
    # --- 5. EKSİKSİZ VE MÜHÜRLÜ DERİN MÜFREDAT (40 ADIM) ---
    training_data = [
        {"module_title": "1. İletişim: print() ve Metin Dünyası", "exercises": [
            ...
            {"msg": "**Pito'nun Notu:** Sayılar (Integer), tırnak gerektirmezler. Tırnak koyarsan Python onu sayı değil, yazı olarak görür ve matematik yapamaz.", "task": "print(___)", "check": lambda c, o, i: "100" in o, "solution": "print(100)", "hint": "Doğrudan 100 yaz."},
        ...
        {"module_title": "3. Mantık: Karar Yapıları (If-Else)", "exercises": [
            {"msg": "**Karar:** Programların beyni `if` bloğudur. Eşitlik sorgusunda `=` değil, mutlaka `==` kullanmalısın.", "task": "if 10 ___ 10: print('OK')", "check": lambda c, o, i: "==" in c, "solution": "if 10 == 10:\n    print('OK')", "hint": "== koy."},
        ...
        {"module_title": "4. Otomasyon: For ve While Döngüleri", "exercises": [
            {"msg": "**Range:** `range(5)` komutu 0'dan 4'e kadar sayı üretir. `for` bu sayılarda adım adım ilerler.", "task": "for i in ___(5): print(i)", "check": lambda c, o, i: "range" in c, "solution": "for i in range(5):\n    print(i)", "hint": "range yaz."},
            ...
            if "___" in code: st.session_state.feedback_msg = "⚠️ Pito bekliyor: Lütfen önce boşluğu doldur!"; st.rerun()
                ...
                try:
                    ...
                    if st.session_state.fail_count < 4:
                        st.session_state.feedback_msg = f"❌ {st.session_state.fail_count}. Hatayı yaptın! 5 Puan Kaybettin. Kalan: {st.session_state.current_potential_score} Puan."
                    else:
