...
# --- 2. SESSION STATE (TÜM HATALARA KARŞI ÇELİK ZIRH - EN ÜSTTE) ---
...
# --- 4. SIDEBAR LİDERLİK TABLOSU (HER AN GÖRÜNÜR) ---
with st.sidebar:
...
with col_app:
            ...
            if in_no:
                if not in_no.isdigit(): st.error("⚠️ Sadece rakam giriniz!")
                    ...
                    if not user_data.empty:
                        ...
                        st.info("🌟 Seni henüz tanımıyorum. Lütfen kaydol.")
    ...
    # --- 6. EKSİKSİZ MÜHÜRLÜ MÜFREDAT ---
    training_data = [
        {"module_title": "1. print() ve Metin Dünyası", "exercises": [
            {"msg": "**Pito'nun Notu:** Python'ın dış dünyayla konuşma yolu `print()` fonksiyonudur. Ekrana yazacağın metinleri mutlaka tırnak (' ') içine almalısın.", "task": "print('___')", "check": lambda c, o, i: "Merhaba Pito" in o, "solution": "print('Merhaba Pito')", "hint": "Metnin başına ve sonuna tırnak koymayı unutma."},
            {"msg": "**Pito'nun Notu:** Sayılar (Integer) tırnak gerektirmez. Tırnak koyarsan Python onu sayı değil, yazı olarak görür.", "task": "print(___)", "check": lambda c, o, i: "100" in o, "solution": "print(100)", "hint": "Sayısal değer olan 100'ü doğrudan tırnaksız yaz."},
            {"msg": "**Pito'nun Notu:** Virgül (`,`) farklı tipleri birleştirirken araya otomatik bir boşluk koyar. Değişkenleri ve metinleri birleştirmek için idealdir.", "task": "print('Puan:', ___)", "check": lambda c, o, i: "100" in o, "solution": "print('Puan:', 100)", "hint": "Virgülden sonra 100 yaz."},
            {"msg": "**Pito'nun Notu:** `#` işareti Python'a 'Bu satırı okuma' demektir. Buna 'Yorum Satırı' diyoruz.", "task": "___ bu bir nottur", "check": lambda c, o, i: "#" in c, "solution": "# bu bir nottur", "hint": "Diyez işaretini kullan."},
            {"msg": "**Pito'nun Notu:** `\\n` kaçış karakteri metni alt satıra böler. Enter tuşuna basılmış gibi davranır.", "task": "print('Üst' + '___' + 'Alt')", "check": lambda c, o, i: "Üst\nAlt" in o, "solution": "print('Üst\\nAlt')", "hint": "Tırnaklar içerisine \\n yaz."}
        ]},
        {"module_title": "2. Hafıza: Değişkenler ve input()", "exercises": [
            {"msg": "**Pito'un Notu:** Değişkenler bellekteki kutulardır. `=` işareti sağdaki değeri soldaki kutuya koyar (Atama).", "task": "yas = ___", "check": lambda c, o, i: "15" in c, "solution": "yas = 15", "hint": "Eşittirden sonra 15 yaz."},
            {"msg": "**Pito'un Notu:** `input()` programı durdurur ve kullanıcıdan bir bilgi bekler. Bu veri her zaman metin (String) olarak gelir.", "task": "ad = ___('Adın: ')", "check": lambda c, o, i: "input" in c, "solution": "ad = input('Adın: ')", "hint": "Girdi almak için input kullanılır."},
            {"msg": "**Pito'un Notu:** Sayıları metne çevirmek için `str()` (Casting) fonksiyonunu kullanırız.", "task": "print(___(10))", "check": lambda c, o, i: "str" in c, "solution": "print(str(10))", "hint": "str fonksiyonunu yerleştir."},
            ...
            {"msg": "**Pito'un Notu:** Değişken isimlerinde Pito'yu sakla. Metinleri tırnakla ata.", "task": "isim = '___'", "check": lambda c, o, i: "Pito" in o, "solution": "isim = 'Pito'", "hint": "Pito yaz."}
        ]},
        ...
        {"module_title": "4. Otomasyon: For ve While Döngüleri", "exercises": [
            {"msg": "**Konu:** `range(5)` sayı üretir. `for` döngüsü bu sayılar üzerinde adım adım ilerler.", "task": "for i in ___(5): print(i)", "check": lambda c, o, i: "range" in c, "solution": "for i in range(5):\n    print(i)", "hint": "range yaz."},
            {"msg": "**Konu:** `while` şart doğru oldukça döner. Döngünün içinde o şartı bir noktada bozmalısın.", "task": "i = 0\n___ i == 0: print('D'); i += 1", "check": lambda c, o, i: "while" in c, "solution": "i = 0\nwhile i == 0:\n    print('D')\n    i += 1", "hint": "while yaz."},
            {"msg": "**Konu:** `break` döngüyü anında bitirir.", "task": "for i in range(5):\n if i == 1: ___", "check": lambda c, o, i: "break" in c, "solution": "for i in range(5):\n    if i == 1:\n        break", "hint": "break yaz."},
        ...
        {"module_title": "5. Gruplama: Listeler", "exercises": [
            {"msg": "**Konu:** Listeler `[]` içindedir. Python'da sayma 0'dan başlar!", "task": "L = [___, 20]", "check": lambda c, o, i: "10" in c, "solution": "L = [10, 20]", "hint": "10 yaz."},
        ...
        {"module_title": "6. Fonksiyonlar ve Sözlükler", "exercises": [
            {"msg": "**Konu:** `def` fonksiyon tanımlama anahtarıdır.", "task": "___ pito(): print('Hi')", "check": lambda c, o, i: "def" in c, "solution": "def pito():\n    print('Hi')", "hint": "def yaz."},
            ...
            {"msg": "**Tuple**, listeye benzer ama içeriği değiştirilemez! `()` ile kurulur.", "task": "t = (___, 2)", "check": lambda c, o, i: "1" in c, "solution": "t = (1, 2)", "hint": "1 yaz."},
            {"msg": "`.keys()` tüm anahtarları getirir.", "task": "d = {'a':1}\nprint(d.___())", "check": lambda c, o, i: "keys" in c, "solution": "d = {'a':1}\nprint(d.keys())", "hint": "keys yaz."},
            {"msg": "`return` sonucu fırlatır.", "task": "def f(): ___ 5", "check": lambda c, o, i: "return" in c, "solution": "def f():\n    return 5", "hint": "return yaz."}
        ]},
        {"module_title": "7. OOP: Nesne Tabanlı Dünya", "exercises": [
            {"msg": "**OOP:** `class` bir taslak/fabrikadır.", "task": "___ Robot: pass", "check": lambda c, o, i: "class" in c, "solution": "class Robot:\n    pass", "hint": "class yaz."},
            {"msg": "Nesne `Robot()` ile üretilir (Instance).", "task": "class Robot: pass\nr = ___", "check": lambda c, o, i: "Robot()" in c, "solution": "class Robot: pass\nr = Robot()", "hint": "Robot() yaz."},
            {"msg": "Özellikler `.` ile atanır.", "task": "class R: pass\nr = R()\nr.___ = 'Mavi'", "check": lambda c, o, i: "renk" in c, "solution": "class R: pass\nr = R()\nr.renk = 'Mavi'", "hint": "renk yaz."},
        ...
        {"module_title": "8. Kalıcılık: Dosya Yönetimi", "exercises": [
            ...
            {"msg": "**'r'** okuma modudur.", "task": "f = open('t.txt', '___')", "check": lambda c, o, i: "r" in c, "solution": "f = open('t.txt', 'r')", "hint": "r yaz."},
            {"msg": "`.read()` içeriği çeker.", "task": "f = open('t.txt', 'r')\nprint(f.___())", "check": lambda c, o, i: "read" in c, "solution": "f = open('t.txt', 'r')\nprint(f.read())", "hint": "read yaz."},
            {"msg": "`.close()` kapatır.", "task": "f = open('t.txt', 'r')\nf.___()", "check": lambda c, o, i: "close" in c, "solution": "f = open('t.txt', 'r')\nf.close()", "hint": "close yaz."}
        ]}
    ]
            ...
            if "___" in code: st.session_state.feedback_msg = "⚠️ Önce boşluğu doldurmalısın!"; st.rerun()
                ...
                try:
                    ...
                    if curr_ex.get('check', lambda c, o, i: True)(code, out, ""):
                        st.session_state.update({'feedback_msg': "✅ Muhteşem! Görevi mühürledin.", 'last_output': out, 'exercise_passed': True})
                    ...
                    if st.session_state.fail_count < 4:
                        ...
                        st.session_state.feedback_msg = "🌿 Bu seferlik puan kazanamadın ama tecrübe kazandın! Çözümü inceleyip ilerleyebilirsin."
                st.rerun()
