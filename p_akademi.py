...
# Liderlik Tablolarını Sidebar'da göster (Giriş öncesi mühürlüdür)
...
# Veriyi oku ve liderlik tablolarını her zaman görünür kıl
db_current = get_db()
...
training_data = [
    ...
    {"module_title": "6. Modülerlik: Fonksiyonlar ve Sözlükler", "exercises": [
        {"msg": "**Pito'nun Notu:** Fonksiyonlar tekrar eden kodları paketler. `def` (define: tanımla) kelimesi ile kurulur.\n\n**Görev:** 'pito' fonksiyonunu tanımlayan **def** kelimesini boşluğa yaz.", "task": "___ pito(): print('Hi')", "check": lambda c, o, i: "def" in c, "solution": "def pito():", "hint": "Fonksiyon tanımlama anahtarı olan def'i düşün."},
        {"msg": "**Pito'nun Notu:** **Sözlükler (Dictionary)**, `{anahtar: değer}` çiftleriyle çalışır. Tıpkı rehberdeki isim ve numara gibi.\n\n**Görev:** 'ad' anahtarına karşılık gelen değer boşluğuna tırnaklar içinde **'Pito'** yaz.", "task": "d = {'ad': '___'}\nprint(d['ad'])", "check": lambda c, o, i: "Pito" in o, "solution": "d = {'ad': 'Pito'}", "hint": "Tırnakların arasına tam istediğim ismi yerleştir."},
        {"msg": "**Pito'nun Notu:** **Tuple (Demet)**, listeye benzer ama parantez `()` ile kurulur ve içeriği değiştirilemez.\n\n**Görev:** Boşluğa sayısal olarak **1** yazarak (1, 2) demetini oluştur.", "task": "t = (___, 2)\nprint(t)", "check": lambda c, o, i: "1" in c, "solution": "t = (1, 2)", "hint": "Sadece eksik olan 1 rakamını koyman yeterli."},
        {"msg": "**Pito'nun Notu:** `.keys()` metodu sözlükteki tüm anahtarları bir liste halinde bize sunar.\n\n**Görev:** Boşluğa **keys** yazarak sözlükteki anahtarları çek.", "task": "d = {'a':1}\nprint(d.___())", "check": lambda c, o, i: "keys" in c, "solution": "d.keys()", "hint": "Anahtarlar kelimesinin İngilizcesini düşün: keys."},
...
with col_main:
    ...
    # FIXED 4. HATA LOGIC: 4. hatada ipucu kutusu kalkar, çözüm bloğu açılır.
