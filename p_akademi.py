...
training_data = [
    {"module_title": "1. Giriş ve Çıktı", "exercises": [
        ...
        {"msg": "Python'da matematiksel değer olan sayıları ekrana yazdırırken **tırnak işareti kullanmayız.** Ekrana 100 sayısını yazdır.", "task": "print(___)", "check": lambda c, o: "100" in o, "solution": "print(100)"},
    ...
    {"module_title": "2. Değişkenler", "exercises": [
        {"msg": "Değişkenler bilgileri saklamaya yarar. yas = 15 yazarak bir tam sayı değişkeni oluştur ve yazdır.", "task": "yas = ___\nprint(yas)", "check": lambda c, o: "15" in o, "solution": "yas = 15\nprint(yas)"},
    ...
    {"module_title": "5. Listeler", "exercises": [
        ...
        {"msg": "Python'da sayma her zaman **0 (sıfır)**'dan başlar! Elemana ulaşmak için `L[0]` yazımı kullanılır. **L** listesinin ilk elemanına (0. indeks) eriş.", "task": "L=[5,6]\nprint(L[___])", "check": lambda c, o: "5" in o, "solution": "L=[5,6]\nprint(L[0])"},
    ...
    {"module_title": "6. Fonksiyonlar ve Veriler", "exercises": [
        ...
        {"msg": "**Tuple (Demet)**, listeye benzer ama **değiştirilemez**. Listeler için `[]`, Demetler için **`()`** kullanılır. (1, 2) demeti oluştur.", "task": "t = (___, 2)\nprint(t)", "check": lambda c, o: "1" in c, "solution": "t = (1, 2)\nprint(t)"},
        {"msg": "**Sözlükler**, 'Anahtar: Değer' çifti tutar. 'ad' anahtarına 'Pito' ata.", "task": "d = {'ad': '___'}", "check": lambda c, o: "Pito" in c, "solution": "d = {'ad': 'Pito'}\nprint(d['ad'])"},
        {"msg": "keys() metodu sözlükteki tüm anahtarları verir.", "task": "d={'a':1}\nprint(d.___())", "check": lambda c, o: "keys" in c, "solution": "d={'a':1}\nprint(d.keys())"},
        {"msg": "**Set (Küme)**, benzersiz koleksiyondur. {1, 2, 1} ile oluştur.", "task": "s = {1, 2, ___}", "check": lambda c, o: "1" in c, "solution": "s = {1, 2, 1}\nprint(s)"}
    ]},
    {"module_title": "7. OOP (Sınıf ve Metotlar)", "exercises": [
        ...
        {"msg": "**Nesneler**, sınıflardan üretilen somut örneklerdir. **R** sınıfını kullanarak **p** adında bir nesne oluştur.", "task": "class R: pass\np = ___()", "check": lambda c, o: "R()" in c, "solution": "class R: pass\np = R()"},
...
with col_main:
    ...
    def run_pito_code(c, user_input=""):
        ...
        try:
            ...
            return f"Hata: Lütfen sayı girin."
...
with col_side:
    ...
    if not df_class_lb.empty:
        ...
        for i, (_, r) in enumerate(df_sort.iterrows()):
            ...
            # YENİ: İsim yanında sınıf bilgisi eklendi
