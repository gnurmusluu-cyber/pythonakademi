...
# --- 5. EKSİKSİZ MÜFREDAT VE DÜZELTİLMİŞ AÇIKLAMALAR ---
training_data = [
    ...
    # Diğer 5 modül (Döngüler, Listeler, Fonk, Veri Yapıları, OOP, Dosyalar) buraya aynı yapıyla eklenmelidir...
]
...
with col_main:
    ...
    if st.session_state.exercise_passed or is_locked:
        if e_idx < 4:
            ...
            # KRİTİK DEĞİŞİKLİK: Modül bitince aynı modülde İNCELEME MODUNDA kalsın
            if st.button("🏆 Modülü Bitir"):
                st.session_state.current_exercise = 4 # Olduğu yerde kalsın
