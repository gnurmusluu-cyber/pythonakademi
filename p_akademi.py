...
if not st.session_state.is_logged_in:
    ...
    with col_mid:
        st.markdown('<div class="pito-bubble">Merhaba! Ben <b>Pito</b>. Python dünyasına hoş geldin. Bugün kodlamanın temellerini bir uzman gibi öğreneceğiz.</div>', unsafe_allow_html=True)
...
# --- 5. KAPSAMLI EĞİTMEN MÜFREDATI ---
training_data = [
    {"module_title": "1. Merhaba Python: İletişim ve Çıktı", "exercises": [
        {"msg": "**Konu Anlatımı:** Python'da bilgisayarın bizimle konuşmasını sağlayan araç `print()` fonksiyonudur. Programların çıktısını görmek, mantığı anlamanın ilk yoludur.\n\n**Görev:** Ekrana tam olarak **'Merhaba Pito'** yazdırmanı istiyorum.", "task": "print('___')", "check": lambda c, o, i: "Merhaba Pito" in o, "solution": "print('Merhaba Pito')", "hint": "Metinleri mutlaka tırnak (' ') içine yazmalısın. Boşluğa Merhaba Pito yazmayı dene!", "has_output": True},
        {"msg": "**Konu Anlatımı:** Veri türleri programlamanın alfabesidir. Metinler tırnak içinde, tam sayılar (integer) ise doğrudan yazılır.\n\n**Görev:** Ekrana sadece sayısal değer olan **100** sayısını bas.", "task": "print(___)", "check": lambda c, o, i: "100" in o, "solution": "print(100)", "hint": "Sayıları yazarken tırnak kullanma, sadece rakamları yaz!", "has_output": True},
        {"msg": "**Konu Anlatımı:** Virgül (`,`) farklı veri türlerini yan yana getirmemizi sağlar. Python bu veriler arasına otomatik bir boşluk koyar.\n\n**Görev:** Önce **'Puan:'** metnini yaz ve yanına **100** sayısını ekle.", "task": "print('Puan:', ___)", "check": lambda c, o, i: "100" in o, "solution": "print('Puan:', 100)", "hint": "Virgülden sonra sadece sayısal değeri yazmalısın.", "has_output": True},
        {"msg": "**Konu Anlatımı:** İyi bir yazılımcı koduna notlar bırakır. `#` işareti 'yorum satırı' demektir. Bilgisayar bu satırı görmezden gelir.\n\n**Görev:** Bir `#` kullanarak bu satırı yorum satırına dönüştür.", "task": "___ bu bir yorumdur", "check": lambda c, o, i: "#" in c, "solution": "# bu bir yorumdur", "hint": "Satırın en başına kare (#) işaretini koymalısın.", "has_output": False},
    ...
    {"module_title": "2. Bellek Yönetimi: Değişkenler ve input()", "exercises": [
        {"msg": "**Konu Anlatımı:** Değişkenler verileri sakladığımız kutulardır. `=` işareti ile kutuya değer koyarız. Bellekte (RAM) yer ayırırız.\n\n**Görev:** **yas** ismindeki değişkene **15** değerini ata.", "task": "yas = ___\nprint(yas)", "check": lambda c, o, i: "15" in o, "solution": "yas = 15\nprint(yas)", "hint": "Eşittir işaretinden sonra sayısal olarak 15 yazmalısın.", "has_output": True},
        {"msg": "**Konu Anlatımı:** Metinsel veriyi saklarken tırnak kullanmalısın. Değişken isimleri anlamlı olmalıdır.\n\n**Görev:** **isim** değişkenine **'Pito'** metnini ata.", "task": "isim = '___'\nprint(isim)", "check": lambda c, o, i: "Pito" in o, "solution": "isim = 'Pito'\nprint(isim)", "hint": "Tırnakların arasına Pito yazmalısın.", "has_output": True},
        {"msg": "**Konu Anlatımı:** `input()` programı durdurur ve klavyeden giriş bekler. Kullanıcıyla etkileşimin tek yoludur.\n\n**Görev:** Kullanıcıya **'Adın: '** sorusunu soran girdi komutunu tamamla.", "task": "ad = ___('Adın: ')\nprint(ad)", "check": lambda c, o, i: "input" in c, "solution": "ad = input('Adın: ')\nprint(ad)", "hint": "Veri almak için 'input' fonksiyonunu kullanmalısın.", "has_output": True, "force_text": True},
        {"msg": "**Konu Anlatımı:** Sayıları metne çeviren `str()` fonksiyonu, veri tipi dönüşümü (Type Casting) yapmamızı sağlar.\n\n**Görev:** 10 sayısını metne çevirerek ekrana basılmasını sağla.", "task": "s = 10\nprint(___(s))", "check": lambda c, o, i: "str" in c, "solution": "s = 10\nprint(str(s))", "hint": "Kısaltma olarak 'str' yazmalısın.", "has_output": True},
        {"msg": "**Konu Anlatımı:** `input()` verisi her zaman metindir. Matematik için `int()` ile tam sayıya çevirmelisin.\n\n**Görev:** Kullanıcıdan sayı al, tam sayıya çevir ve 1 ekleyip yazdır.", "task": "n = ___(___('S: '))\nprint(n + 1)", "check": lambda c, o, i: "int" in c and (str(int(i if i.isdigit() else 0) + 1) in o), "solution": "n = int(input('10'))\nprint(n+1)", "hint": "Dıştaki boşluğa 'int', içteki boşluğa 'input' yazmalısın.", "has_output": True}
    ]},
    {"module_title": "3. Karar Mekanizmaları: Mantık", "exercises": [{"msg": "**Konu Anlatımı:** Programların zekası `if` yapısından gelir. Eşitlik için `==` kullanılır.\n\n**Görev:** 10'un 10'a eşitliğini kontrol et.", "task": "if 10 ___ 10: print('Eşit!')", "check": lambda c, o, i: "==" in c, "solution": "if 10 == 10: print('Eşit!')", "hint": "Eşitlik için çift eşittir (==) kullanılır.", "has_output": True}]*5},
    {"module_title": "4. Otomasyon: Döngülerin Gücü", "exercises": [{"msg": "**Konu Anlatımı:** Yazılımcılar hamallık yapmaz, döngü kurar. `for` ve `range()` işleri otomatiğe bağlar.\n\n**Görev:** Ekrana tam 3 kez 'Pito' yazdır.", "task": "for i in ___(3): print('Pito')", "check": lambda c, o, i: "range" in c, "solution": "for i in range(3): print('Pito')", "hint": "Aralık oluşturmak için 'range' kullanmalısın.", "has_output": True}]*5},
    {"module_title": "5. Gruplama: Listeler ve Koleksiyonlar", "exercises": [{"msg": "**Konu Anlatımı:** Listeler birden fazla veriyi tek kutuda toplar. Python'da saymaya 0'dan başlarız.\n\n**Görev:** Listeye eksik olan 10 sayısını ekle.", "task": "L = [___, 20]", "check": lambda c, o, i: "10" in c, "solution": "L = [10, 20]", "hint": "Boşluğa sadece 10 yazmalısın.", "has_output": False}]*5},
    {"module_title": "6. Modülerlik: Fonksiyonlar", "exercises": [{"msg": "**Konu Anlatımı:** Fonksiyonlar tekrarı önler. `def` (define) anahtar kelimesiyle tanımlanır.\n\n**Görev:** Fonksiyonu tanımlamaya başla.", "task": "___ f(): print('X')", "check": lambda c, o, i: "def" in c, "solution": "def f(): print('X')", "hint": "Tanımlama için 'def' yazmalısın.", "has_output": False}]*5},
    {"module_title": "7. OOP: Nesne Tabanlı Dünya", "exercises": [{"msg": "**Konu Anlatımı:** Sınıflar (Class) nesne fabrikalarıdır. Bir kalıptan kopyalar üretiriz.\n\n**Görev:** Yeni bir 'Robot' sınıfı tanımla.", "task": "___ Robot: pass", "check": lambda c, o, i: "class" in c, "solution": "class Robot: pass", "hint": "Sınıf oluşturmak için 'class' yazmalısın.", "has_output": False}]*5},
    {"module_title": "8. Kalıcılık: Dosya Yönetimi", "exercises": [{"msg": "**Konu Anlatımı:** Verileri kalıcı kılmak için dosyaları `open()` ve **'w'** kipiyle açarız.\n\n**Görev:** Yazma modunda bir dosya aç.", "task": "dosya = ___('n.txt', '___')", "check": lambda c, o, i: "open" in c, "solution": "dosya = open('n.txt', 'w')", "hint": "Açmak için 'open', yazma modu için 'w' kullan.", "has_output": False}]*5},
]
...
with col_main:
    ...
    if is_locked:
        ...
        if st.session_state.fail_count < 4 and not st.session_state.exercise_passed:
            ...
            # --- KRİTİK: GİRİŞ SİMÜLASYONU VURGUSU ---
            ...
            if st.button("🔍 Kodumu Kontrol Et", use_container_width=True):
                if "___" in code:
                    ...
                    st.session_state.feedback_msg = "🔴 DUR! Giriş kutusuna bir şey yazmadın!"
                    st.rerun()
    ...
    # --- TEK MERKEZİ ÇIKTI VE MESAJ ALANI (FIXED) ---
