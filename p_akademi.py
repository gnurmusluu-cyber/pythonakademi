...
st.markdown("""
    <style>
    /* ANA TEMA VE MUTLAK KARANLIK ZORLAMASI */
    .stApp { 
    ...
    .gorev-label {
        ...
        font-size: 1.2em !important; text-transform: uppercase;
    ...
    .leader-card:hover { transform: translateX(5px); border-color: #00FF00 !important; }
    ...
    .hero-panel h3 { color: #00FF00 !important; font-weight: 900 !important; margin: 0 !important; }
    ...
    [data-testid="stCodeBlock"], .stCodeBlock pre {
        background-color: #000000 !important;
    ...
    .stTabs [data-baseweb="tab-list"] { background-color: #1E1E2F !important; border-radius: 12px 12px 0 0; padding: 10px; }
...
# --- 5. NAVİGASYON VE İLERLEME MOTORU ---
...
def liderlik_tablosu_goster(user_sinif=None):
    ...
    try:
        ...
        with t_okul:
            df_okul = df.sort_values(by="toplam_puan", ascending=False).head(8)
            for i, r in enumerate(df_okul.itertuples(), 1):
...
if st.session_state.user is None:
    ...
    with col_main:
        ...
        # ÜST İLERLEME ÇUBUĞU (AKADEMİ YOLCULUĞU)
