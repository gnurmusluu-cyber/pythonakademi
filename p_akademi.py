...
# --- 4. ANA LAYOUT (LİDERLİK TABLOSUNU ST.STOP ÖNCESİNDE MÜHÜRLEME) ---
col_app, col_ranking = st.columns([3, 1])

# Liderlik Tablosu: Giriş ekranı dahil her an görünür
with col_ranking:
...
with col_app:
    ...
    if st.session_state.graduation_view and st.session_state.current_module >= 7:
        ...
        with c1:
            if st.button("🔄 Eğitimi Tekrar Al (Puan Sıfırlanır)"):
                st.session_state.update({'db_module': 0, 'db_exercise': 0, 'current_module': 0, 'current_exercise': 0, 'total_score': 0, 'completed_modules': [False]*8, 'graduation_view': False, 'scored_exercises': set(), 'exercise_passed': False})
                force_save(); st.rerun()
        with c2:
    ...
    # --- 6. MÜHÜRLÜ VE BOL AÇIKLAMALI PEDAGOJİK MÜFREDAT ---
    training_data = [
        {"module_title": "1. print() ve Metin Dünyası", "exercises": [
            {"msg": "**Pito'nun Notu:** Python'ın dünyayla konuşma yolu `print()` fonksiyonudur. Ekrana yazacağın metinleri mutlaka tırnak (' ') içine almalısın. Tırnaklar Python'a 'buradaki ifadeyi olduğu gibi yansıt' komutunu verir.\n\n**GÖREV:** Boşluğa tam olarak **'Merhaba Pito'** metnini tırnaklar içerisinde yaz!", "task": "print('___')", "check": lambda c, o, i: "Merhaba Pito" in o, "solution": "print('Merhaba Pito')", "hint": "Metnin başına ve sonuna tek (') veya çift (\") tırnak koymayı unutma."},
            ...
            {"msg": "**Pito'nun Notu:** Virgül (`,`) farklı veri tiplerini aynı satırda birleştirirken araya otomatik boşluk koyar. Bu en profesyonel yoldur.\n\n**GÖREV:** 'Puan:' metni ile **100** sayısını yan yana basmak için boşluğa **100** yaz.", "task": "print('Puan:', ___)", "check": lambda c, o, i: "100" in o, "solution": "print('Puan:', 100)", "hint": "Virgülden sonra sadece sayısal değeri yaz."},
            {"msg": "**Pito'nun Notu:** `#` işareti Python'a 'Bu satırı okuma' demektir. Buna 'Yorum Satırı' diyoruz.\n\n**GÖREV:** Satırın en başına **#** işaretini koyarak bu satırı etkisiz hale getir.", "task": "___ bu bir nottur", "check": lambda c, o, i: "#" in c, "solution": "# bu bir nottur", "hint": "Klavyeden diyez (#) işaretini yerleştir."},
            {"msg": "**Pito'nun Notu:** `\\n` metni alt satıra böler. Sanki klavyede Enter tuşuna basılmış gibi davranır.\n\n**GÖREV:** 'Üst' ve 'Alt' kelimelerini alt alta getirmek için tırnaklar içindeki boşluğa **\\n** yaz.", "task": "print('Üst' + '___' + 'Alt')", "check": lambda c, o, i: "Üst\nAlt" in o, "solution": "print('Üst\\nAlt')", "hint": "Tırnaklar içerisine ters eğik çizgi (\\) ve n harfini yaz: \\n"}
        ]},
        {"module_title": "2. Hafıza: Değişkenler ve input()", "exercises": [
            {"msg": "**Pito'un Notu:** Değişkenler bellekteki kutulardır. `=` işareti sağdaki değeri soldaki kutunun içine koyar (Atama).\n\n**GÖREV:** `yas` değişkenine sayısal olarak **15** değerini ata.", "task": "yas = ___", "check": lambda c, o, i: "15" in c, "solution": "yas = 15", "hint": "Eşittirden sonra sadece 15 yaz."},
            {"msg": "**Pito'un Notu:** `input()` programı durdurur ve kullanıcıdan bir bilgi bekler. Bu veri her zaman metin (String) olarak gelir.\n\n**GÖREV:** Kullanıcıdan adını almak için boşluğa **input** fonksiyonunu yaz.", "task": "ad = ___('Adın: ')", "check": lambda c, o, i: "input" in c, "solution": "ad = input('Adın: ')", "hint": "Veri alma komutu olan input kelimesini kullan."},
            {"msg": "**Pito'un Notu:** Sayıları metne çevirmemiz gerektiğinde (Casting) `str()` fonksiyonunu kullanırız.\n\n**GÖREV:** 10 sayısını metne çeviren **str** fonksiyonunu yaz.", "task": "print(___(10))", "check": lambda c, o, i: "str" in c, "solution": "print(str(10))", "hint": "str fonksiyonunu yerleştir."},
            {"msg": "**Pito'un Notu:** Matematik yapabilmek için `input()` ile gelen metni `int()` ile 'tam sayıya' çevirmelisin.\n\n**GÖREV:** Dış boşluğa **int**, içe **input** yazarak sayı girişi al.", "task": "n = ___(___('S: '))", "check": lambda c, o, i: "int" in c and "input" in c, "solution": "n = int(input('S: '))", "hint": "int(input()) yapısını kur."},
            {"msg": "**Pito'un Notu:** Metin verilerini saklarken tırnak şarttır. Değişken isminde Pito ismini sakla.\n\n**GÖREV:** `isim` değişkenine **'Pito'** metnini ata.", "task": "isim = '___'", "check": lambda c, o, i: "Pito" in o, "solution": "isim = 'Pito'", "hint": "Tırnaklar arasına Pito yaz."}
        ]},
        {"module_title": "3. Karar Yapıları: If-Else Mantığı", "exercises": [
            {"msg": "**Pito'un Notu:** Programların karar mekanizması `if` bloğuyla başlar. Eşitlik sorgusunda `=` değil, mutlaka `==` (çift eşittir) kullanmalısın.\n\n**GÖREV:** Sayı 10'a eşitse kontrolü için boşluğa çift eşittir (**==**) operatörünü koy.", "task": "if 10 ___ 10: print('OK')", "check": lambda c, o, i: "==" in c, "solution": "if 10 == 10:\n    print('OK')", "hint": "Eşitlik için çift eşittir koy."},
            {"msg": "**Pito'un Notu:** `else:` bloğu, 'if' şartı sağlanmadığında devreye giren otomatik plandır.\n\n**GÖREV:** Şart sağlanmazsa 'Hata' yazdıran yolu tamamla. Boşluğa **else** yaz.", "task": "if 5 > 10: pass\n___: print('Hata')", "check": lambda c, o, i: "else" in c, "solution": "if 5 > 10: pass\nelse:\n    print('Hata')", "hint": "Sadece else: yaz."},
            {"msg": "**Pito'un Notu:** Birden fazla şartı denetlemek için `elif` (else if) kullanılır.\n\n**GÖREV:** Puan 50'den büyükse kontrolü için boşluğa **elif** yaz.", "task": "p = 60\nif p < 50: pass\n___ p > 50: print('G')", "check": lambda c, o, i: "elif" in c, "solution": "if p < 50: pass\nelif p > 50:\n    print('G')", "hint": "elif komutunu kullan."},
    ...
    if new_m_idx != st.session_state.current_module:
        st.session_state.update({'current_module': new_m_idx, 'current_exercise': 0, 'fail_count': 0, 'exercise_passed': False, 'current_potential_score': 20, 'feedback_msg': ""}); st.rerun()
        ...
        if st.button("🔍 Kodumu Kontrol Et", use_container_width=True):
            if "___" in code: st.session_state.feedback_msg = "⚠️ Önce boşluğu doldurmalısın!"; st.rerun()
                ...
                try:
                    ...
                    st.session_state.feedback_msg = f"❌ 5 Puan Kaybettin! Kalan: {st.session_state.current_potential_score} Puan. Tekrar dene!" if st.session_state.fail_count < 4 else "🌿 Puan kazanamadın ama tecrübe kazandın! Çözümü inceleyip ilerle."
                st.rerun()
