...
# --- 2. ÖZEL TASARIM VE KONUŞMA BALONU (CSS) ---
st.markdown("""
    <style>
...
if st.session_state.student_name == "":
    ...
    with col_mid:
        # Pito Konuşma Balonu
        st.markdown("""
            <div class="pito-bubble">
                Merhaba Arkadaşlar! Ben Pito. Haydi birlikte Python'ın eğlenceli dünyasına giriş yapalım!
            </div>
        """, unsafe_allow_html=True)
        
        # Pito Resmi (Dosya varsa göster, yoksa internetten yedek çek)
...
training_data = [
    ...
    {"module_title": "4. Döngü Yapıları", "exercises": [
        ...
        {"msg": "Döngüyü kır (break).", "task": "for i in range(5):\n if i==2: ___\n print(i)", "check": lambda c, o: "2" not in o},
...
# --- KRİTİK HATA DÜZELTME ALANI (VALUEERROR ÇÖZÜMÜ) ---
if st.button("🔍 Görevi Kontrol Et", use_container_width=True):
    old_stdout = sys.stdout 
    new_stdout = StringIO()
    sys.stdout = new_stdout # Değişken ataması ayrıldı, unpack hatası giderildi
