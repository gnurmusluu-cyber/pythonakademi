...
training_data = [
    ...
    {"module_title": "6. Fonksiyonlar ve Gelişmiş Veriler", "exercises": [
        ...
        {"msg": "**Tuple (Demet)**, listeye benzer ama **değiştirilemez**. () kullanılır.", "task": "t = (___, 2)", "check": lambda c, o: "1" in c, "solution": "t = (1, 2)\nprint(t)"},
        ...
        {"msg": "keys() metodu sözlükteki tüm anahtar isimlerini verir.", "task": "d={'a':1}\nprint(d.___())", "check": lambda c, o: "keys" in c, "solution": "d={'a':1}\nprint(d.keys())"},
    ...
    {"module_title": "8. Dosya Yönetimi", "exercises": [
        {"msg": "open() fonksiyonu dosya açar. **'w' (write)** kipi yazılabilir demektir. n.txt dosyasını 'w' moduyla aç.", "task": "dosya = ___('n.txt', '___')", "check": lambda c, o: "open" in c and "'w'" in c, "solution": "dosya = open('n.txt', 'w')\nprint('Açıldı.')"},
...
with col_main:
    ...
    if st.session_state.db_module >= 8:
        ...
        with c2:
            if st.button("🏆 Liderlik Listesinde Kal"): st.info("Puanın korundu. Liderlik listesinde kalmaya devam ediyorsun.")
    ...
    with c_next:
        if st.session_state.exercise_passed or is_locked:
            if e_idx < 4:
                ...
                # KRİTİK DÜZELTME: 8. Modül sonundaki butonu Mezun Moduna yönlendirir
                if st.button("🏆 Modülü Bitir"):
                    if st.session_state.current_module < 7:
                        ...
                        # 8. Modül bittiyse koordinatları mezuniyet eşiğine kilitle
