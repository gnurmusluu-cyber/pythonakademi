    ...
    with col_mid:
        ...
        if in_no_raw:
            ...
            if not user_data.empty:
                ...
                st.success(f"Puanın: {row['Puan']} | " + (f"Tebrikler, Eğitimi Tamamladın! 🎓" if m_v >= 8 else f"Kaldığın Yer: Modül {m_v+1}, Adım {e_v+1}"))
                c1, c2 = st.columns(2)
                with c1:
                    if st.button("🚀 Devam Et"):
                        ...
                        st.session_state[f"sel_{st.session_state.student_no}"] = [f"{'✅' if st.session_state.completed_modules[i] else '📖'} Modül {i+1}" for i in range(8)][st.session_state.current_module]
...
training_data = [
    {"module_title": "1. Giriş ve Çıktı", "exercises": [{"msg": "print() fonksiyonu ekrana çıktı vermemizi sağlar. Hadi dene: Ekrana 'Merhaba Pito' yazdır.", "task": "print('___')", "check": lambda c, o: "Merhaba Pito" in o, "solution": "print('Merhaba Pito')"}, {"msg": "Sayıları ekrana yazdırmak için tırnak işareti kullanmamıza gerek yoktur. Şimdi 100 sayısını yazdır.", "task": "print(___)", "check": lambda c, o: "100" in o, "solution": "print(100)"}, {"msg": "print() içinde birden fazla veriyi virgül kullanarak yan yana yazdırabilirsin. 'Puan:' ve 100 sayısını yazdır.", "task": "print('Puan:', ___)", "check": lambda c, o: "100" in o, "solution": "print('Puan:', 100)"}, {"msg": "Kodlarımıza not eklemek için # işaretini kullanırız.", "task": "___ Bu bir nottur", "check": lambda c, o: "#" in c, "solution": "# Bu bir nottur"}, {"msg": "'\\n' karakteri bir alt satıra geçişi temsil eder.", "task": "print('Üst' + '___' + 'Alt')", "check": lambda c, o: "\n" in o, "solution": "print('Üst' + '\\n' + 'Alt')"}]},
    {"module_title": "2. Değişkenler", "exercises": [{"msg": "Değişkenler bilgi saklayan kutulardır. yas = 15 tanımla.", "task": "yas = ___\nprint(yas)", "check": lambda c, o: "15" in o, "solution": "yas = 15\nprint(yas)"}, {"msg": "Metinler değişkenlerde tırnak içinde saklanır.", "task": "isim = '___'\nprint(isim)", "check": lambda c, o: "Pito" in o, "solution": "isim = 'Pito'\nprint(isim)"}, {"msg": "input() kullanıcıdan bilgi almamızı sağlar. 'Adın: ' sorusuyla bir isim al.", "task": "ad = ___('Adın: ')\nprint(ad)", "check": lambda c, o: "input" in c, "solution": "ad = input('Adın: ')\nprint(ad)"}, {"msg": "str() sayıları metne dönüştürür. 10 sayısını metne çevir.", "task": "s = 10\nprint(___(s))", "check": lambda c, o: "str" in c, "solution": "s = 10\nprint(str(s))"}, {"msg": "int() ile girişi tam sayıya çevirmelisin.", "task": "n = ___(___('S: '))\nprint(n + 1)", "check": lambda c, o: "int" in c, "solution": "n = int(input('10'))\nprint(n + 1)"}]},
    {"module_title": "3. Karar Yapıları", "exercises": [{"msg": "Eşitlik kontrolü için '==' kullanılır.", "task": "if 10 ___ 10: print('X')", "check": lambda c, o: "==" in c, "solution": "if 10 == 10: print('X')"}, {"msg": "'>=' büyük eşit kontrolü sağlar.", "task": "if 5 ___ 5: print('Z')", "check": lambda c, o: ">=" in c, "solution": "if 5 >= 5: print('Z')"}, {"msg": "Değilse durumunda 'else:' bloğu çalışır.", "task": "if 5>10: pass\n___: print('Y')", "check": lambda c, o: "else" in c, "solution": "if 5>10: pass\nelse: print('Y')"}, {"msg": "'and' ile iki koşulun da doğru olması gerekir.", "task": "if 1==1 ___ 2==2: print('OK')", "check": lambda c, o: "and" in c, "solution": "if 1==1 and 2==2: print('OK')"}, {"msg": "'elif' ile ek koşullar eklenir.", "task": "if 5>10: pass\n___ 5==5: print('A')", "check": lambda c, o: "elif" in c, "solution": "if 5>10: pass\nelif 5==5: print('A')"}]},
    {"module_title": "4. Döngüler", "exercises": [{"msg": "range(3) ile 3 kez 'X' yazdır.", "task": "for i in ___(3): print('X')", "check": lambda c, o: o.count("X")==3, "solution": "for i in range(3): print('X')"}, {"msg": "'while' ile döngü başlat.", "task": "i=0\n___ i<1: print('Y'); i+=1", "check": lambda c, o: "while" in c, "solution": "i=0\nwhile i<1: print('Y'); i+=1"}, {"msg": "'break' döngüyü aniden kırar ve çıkar.", "task": "for i in range(3):\n if i==1: ___\n print(i)", "check": lambda c, o: "break" in c, "solution": "for i in range(3):\n if i==1: break\n print(i)"}, {"msg": "'continue' o adımı pas geçer.", "task": "for i in range(3):\n if i==1: ___\n print(i)", "check": lambda c, o: "continue" in c, "solution": "for i in range(3):\n if i==1: continue\n print(i)"}, {"msg": "Döngü sayacını (i) ekrana yazdır.", "task": "for i in range(2): print(___)", "check": lambda c, o: "1" in o, "solution": "for i in range(2): print(i)"}]},
    {"module_title": "5. Listeler", "exercises": [{"msg": "Listeler [] içinde birden fazla veri tutar. [10, 20] oluştur.", "task": "L = [___, 20]", "check": lambda c, o: "10" in c, "solution": "L=[10, 20]\nprint(L)"}, {"msg": "Listenin 0. indeksine eriş.", "task": "L=[5,6]\nprint(L[___])", "check": lambda c, o: "5" in o, "solution": "L=[5,6]\nprint(L[0])"}, {"msg": "len() fonksiyonu listenin uzunluğunu verir.", "task": "L=[1,2]\nprint(___(L))", "check": lambda c, o: "2" in o, "solution": "L=[1,2]\nprint(len(L))"}, {"msg": "append() ile listeye 30 ekle.", "task": "L=[10]\nL.___(___)\nprint(L)", "check": lambda c, o: "30" in o, "solution": "L=[10]\nL.append(30)\nprint(L)"}, {"msg": "pop() ile son elemanı sil.", "task": "L=[1,2]\nL.___()\nprint(L)", "check": lambda c, o: "1" in o, "solution": "L=[1,2]\nL.pop()\nprint(L)"}]},
    {"module_title": "6. Fonksiyonlar & Veri Yapıları", "exercises": [{"msg": "'def' ile fonksiyon tanımlanır.", "task": "___ f(): print('X')", "check": lambda c, o: "def" in c, "solution": "def f(): print('X')"}, {"msg": "Tuple (1, 2) demeti oluştur. Değiştirilemez listelerdir.", "task": "t = (___, 2)", "check": lambda c, o: "1" in c, "solution": "t = (1, 2)\nprint(t)"}, {"msg": "Sözlükler anahtar-değer çiftidir. 'ad' anahtarına 'Pito' ata.", "task": "d = {'ad': '___'}", "check": lambda c, o: "Pito" in c, "solution": "d = {'ad': 'Pito'}\nprint(d['ad'])"}, {"msg": "keys() metodu sözlükteki tüm anahtar isimlerini verir.", "task": "d={'a':1}\nprint(d.___())", "check": lambda c, o: "keys" in c, "solution": "d={'a':1}\nprint(d.keys())"}, {"msg": "set() tanımla {}. Benzersiz veri tutar.", "task": "s = {1, 2, ___}", "check": lambda c, o: "1" in c, "solution": "s = {1, 2, 1}"}]},
    {"module_title": "7. OOP (Sınıf ve Metotlar)", "exercises": [{"msg": "Sınıf taslağı için 'class' (küçük harf!) kullanılır.", "task": "___ Robot: pass", "check": lambda c, o: "class" in c, "solution": "class Robot: pass"}, {"msg": "Sınıftan 'p' adında bir nesne üret.", "task": "class R: pass\np = ___()", "check": lambda c, o: "R()" in c, "solution": "class R: pass\np = R()"}, {"msg": "Özelliklere nokta '.' ile erişilir. Robota 'renk' niteliği ekle.", "task": "class R: pass\np=R()\np.___ = 'Mavi'", "check": lambda c, o: "renk" in c, "solution": "class R: pass\np=R()\np.renk = 'Mavi'"}, {"msg": "Metotlar sınıf içi fonksiyonlardır ve ilk parametresi her zaman 'self' olmalıdır.", "task": "class R:\n def ___(self):\n  print('Bip!')", "check": lambda c, o: "ses" in c, "solution": "class R:\n def ses(self):\n  print('Bip!')"}, {"msg": "Metotları çalıştırmak için 'nesne_adi.metot_adi()' kullanılır.", "task": "class R: def s(self): print('X')\nr=R()\nr.___()", "check": lambda c, o: "s()" in c, "solution": "class R: def s(self): print('X')\nr=R()\nr.s()"}]},
    {"module_title": "8. Dosya İşlemleri", "exercises": [
        {"msg": "open() fonksiyonu dosya açar. 'w' (write) kipi yazılabilir anlamına gelir.", "task": "dosya = ___('n.txt', '___')", "check": lambda c, o: "open" in c and "'w'" in c, "solution": "dosya = open('n.txt', 'w')\nprint('Yazma modunda açıldı.')"},
        {"msg": "write() metodu dosyaya bilgi yazar. 'Pito' yazdır ve kapat.", "task": "f = open('t.txt', 'w')\nf.___('Pito')\nf.close()", "check": lambda c, o: "write" in c, "solution": "f = open('t.txt', 'w'); f.write('Pito'); f.close()"},
        {"msg": "'r' (read) kipi yalnızca okunabilir anlamına gelir.", "task": "f = open('t.txt', '___')", "check": lambda c, o: "'r'" in c, "solution": "f = open('t.txt', 'r'); f.close()"},
        {"msg": "read() içeriği getirir.", "task": "f = open('t.txt', 'r')\nicerik = f.___()\nprint(icerik)\nf.close()", "check": lambda c, o: "read" in c, "solution": "f = open('t.txt', 'w'); f.write('Pito Akademi'); f.close(); f = open('t.txt', 'r'); print(f.read()); f.close()"},
...
with col_main:
    ...
    # EĞİTİM TAMAMLANMIŞSA (Mezun Modu)
    if st.session_state.db_module >= 8:
        st.balloons()
        st.success("### 🎉 Tebrikler! Eğitimi Başarıyla Tamamladın.")
        st.markdown('<div class="pito-bubble">Harikasın! Python yolculuğunun bu etabını başarıyla bitirdin. Artık modülleri inceleyebilir veya baştan başlayabilirsin.</div>', unsafe_allow_html=True)
        
        c1, c2 = st.columns(2)
        with c1:
            st.markdown('<div class="restart-btn">', unsafe_allow_html=True)
            if st.button("🔄 Eğitimi Tekrar Al (Puan Sıfırlanır)"):
                st.session_state.db_module, st.session_state.db_exercise = 0, 0
        ...
        with c2:
            if st.button("🏆 Liderlik Listesinde Kal"):
                st.info("Puanın korundu. Liderlik tablosunda yerini görüyorsun.")

        st.divider()
        st.subheader("📖 Modülleri Gözden Geçir (İnceleme Modu)")

    # MODÜL SEÇİCİ (Garantili Senkron)
    ...
    sel_mod = st.selectbox("İncelemek İstediğin Modülü Seç:", mod_titles, key=f"sel_{st.session_state.student_no}")
    ...
    with c_msg:
        st.info(f"##### 🗣️ Pito:\n{curr_ex['msg']}")
        st.caption(f"Adım: {e_idx + 1}/5 " + ("🔒 Tamamlandı (İnceleme Modu)" if is_locked else f"🎁 Kazanılacak Puan: {st.session_state.current_potential_score}"))
