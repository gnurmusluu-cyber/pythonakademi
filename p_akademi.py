...
training_data = [
    {"module_title": "1. Giriş ve Çıktı", "exercises": [
        {"msg": "Python'da ekrana yazı yazdırmak için **print()** kullanılır. Metinler mutlaka **tırnak** içinde olmalıdır.", "task": "print('___')", "check": lambda c, o: "Merhaba" in o, "solution": "print('Merhaba Pito')"},
        {"msg": "Sayılar için tırnak gerekmez. **100** yazdır.", "task": "print(___)", "check": lambda c, o: "100" in o, "solution": "print(100)"},
        {"msg": "Farklı verileri **virgül (,)** ile ayırırız.", "task": "print('Puan:', ___)", "check": lambda c, o: "100" in o, "solution": "print('Puan:', 100)"},
        {"msg": "Yorum satırı için **#** kullanılır.", "task": "___ Bu bir not", "check": lambda c, o: "#" in c, "solution": "# Not"},
    ...
    {"module_title": "3. Karar Yapıları", "exercises": [
        ...
        {"msg": "Şart yanlışsa **else:** çalışır.", "task": "if 5>10: pass\n___: print('Y')", "check": lambda c, o: "else" in c, "solution": "else"},
        {"msg": "Büyük veya eşit mi? **>=**", "task": "if 5 ___ 5: print('Z')", "check": lambda c, o: ">=" in c, "solution": ">="},
        {"msg": "**and** ile iki şart da doğru olmalı.", "task": "if 1==1 ___ 2==2: print('OK')", "check": lambda c, o: "and" in c, "solution": "and"},
    ...
    {"module_title": "4. Döngüler", "exercises": [
        {"msg": "3 kez tekrar için **range(3)** kullan.", "task": "for i in ___(3): print('X')", "check": lambda c, o: o.count("X")==3, "solution": "range(3)"},
        {"msg": "**while** ile döngü kur.", "task": "i=0\n___ i<1: print('Y'); i+=1", "check": lambda c, o: "while" in c, "solution": "while"},
        {"msg": "**break** ile döngüyü bitir.", "task": "for i in range(3):\n if i==1: ___\n print(i)", "check": lambda c, o: "break" in c, "solution": "break"},
...
with col_main:
    ...
    if [i for i in range(8) if sel_mod.endswith(training_data[i]['module_title'])][0] != st.session_state.current_module:
        st.session_state.current_module = [i for i in range(8) if sel_mod.endswith(training_data[i]['module_title'])][0]
        ...
        if st.button("🔍 Kontrol Et", use_container_width=True):
            ...
            if out.startswith("⚠️") or out.startswith("❌"): st.error(out)
                ...
                if curr_ex['check'](code, out):
                    st.success("Tebrikler! Görev tamam. ✅"); st.code(out)
