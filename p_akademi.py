...
training_data = [
    ...
    {"module_title": "6. Veri Yapıları", "exercises": [{"msg": "'def' ile fonksiyon tanımlanır.", "task": "___ f(): print('X')", "check": lambda c, o: "def" in c, "solution": "def f(): print('X')"}, {"msg": "Tuple (1, 2) demeti oluştur.", "task": "t = (___, 2)", "check": lambda c, o: "1" in c, "solution": "t = (1, 2)\nprint(t)"}, {"msg": "Sözlükler anahtar-değer çiftidir. 'ad' anahtarına 'Pito' ata.", "task": "d = {'ad': '___'}", "check": lambda c, o: "Pito" in c, "solution": "d = {'ad': 'Pito'}\nprint(d['ad'])"}, {"msg": "keys() metodu sözlükteki tüm anahtar isimlerini verir.", "task": "d={'a':1}\nprint(d.___())", "check": lambda c, o: "keys" in c, "solution": "d={'a':1}\nprint(d.keys())"}, {"msg": "set() tanımla {}. Benzersiz veri tutar.", "task": "s = {1, 2, ___}", "check": lambda c, o: "1" in c, "solution": "s = {1, 2, 1}"}]},
    {"module_title": "7. OOP", "exercises": [{"msg": "class ile sınıf tanımla. (Küçük harf!)", "task": "___ Robot: pass", "check": lambda c, o: "class" in c, "solution": "class Robot: pass"}, {"msg": "Nesne üret.", "task": "class R: pass\np = ___()", "check": lambda c, o: "R()" in c, "solution": "class R: pass\np = R()"}, {"msg": "Renk niteliği ata.", "task": "class R: pass\np=R()\np.___ = 'Mavi'", "check": lambda c, o: "renk" in c, "solution": "class R: pass\np=R()\np.renk = 'Mavi'"}, {"msg": "Metot ekle. (self eklemeyi unutma!)", "task": "class R:\n def ___(self):\n  print('Bip')", "check": lambda c, o: "ses" in c, "solution": "class R:\n def ses(self):\n  print('Bip')"}, {"msg": "Metodu çağır.", "task": "class R: def s(self): print('X')\nr=R()\nr.___()", "check": lambda c, o: "s()" in c, "solution": "class R: def s(self): print('X')\nr=R()\nr.s()"}]},
    {"module_title": "8. Dosya İşlemleri", "exercises": [{"msg": "open() ile dosya aç. 'w' kipi yazılabilir demektir.", "task": "dosya = ___('n.txt', '___')", "check": lambda c, o: "open" in c and "'w'" in c, "solution": "dosya = open('n.txt', 'w')\nprint('Açıldı.')"}, {"msg": "write() metodu dosyaya bilgi yazar.", "task": "f = open('t.txt', 'w')\nf.___('Pito')\nf.close()", "check": lambda c, o: "write" in c, "solution": "f = open('t.txt', 'w'); f.write('Pito'); f.close()"}, {"msg": "'r' kipi yalnızca okunabilir demektir.", "task": "f = open('t.txt', '___')", "check": lambda c, o: "'r'" in c, "solution": "f = open('t.txt', 'r'); f.close()"}, {"msg": "read() içeriği getirir.", "task": "f = open('t.txt', 'r')\nicerik = f.___()\nprint(icerik)\nf.close()", "check": lambda c, o: "read" in c, "solution": "f = open('t.txt', 'w'); f.write('Pito'); f.close(); f = open('t.txt', 'r'); print(f.read()); f.close()"}, {"msg": "Dosyayı mutlaka close() ile kapatmalıyız.", "task": "f = open('t.txt', 'r')\nf.___()", "check": lambda c, o: "close" in c, "solution": "f = open('t.txt', 'r'); f.close()"}]}
]
...
with col_main:
    ...
    # MODÜL SEÇİCİ (HATA ALMAMAK İÇİN İNDEX ÜZERİNDEN KONTROL)
    ...
    # KRİTİK DEĞİŞİKLİK: Key kaldırıldı, sadece index ve session_state kullanılıyor.
