...
st.markdown("""
    ...
    .pito-bubble {
        ...
        font-weight: 500 !important; font-size: 1.2rem !important; box-shadow: 10px 10px 30px rgba(58, 123, 213, 0.1) !important;
    ...
    .ranking-card {
        ...
        border-radius: 12px !important; padding: 12px !important; margin-bottom: 10px !important;
        display: flex !important; justify-content: space-between !important; align-items: center !important;
        border-left: 5px solid #3a7bd5 !important;
    }
...
with col_main:
    ...
    training_data = [
        ...
        {"module_title": "4. Otomasyon: For ve While Döngüleri", "exercises": [
            ...
            {"msg": "**break:** Döngüyü anında bitiren acil çıkış kapısıdır.", "task": "for i in R: if i==1: ___", "check": lambda c, o, i: "break" in c, "solution": "break", "hint": "break."},
            {"msg": "**continue:** O adımı pas geçip döngünün başına geri döner.", "task": "for i in R: if i==1: ___", "check": lambda c, o, i: "continue" in c, "solution": "continue", "hint": "continue."},
        ...
        {"module_title": "6. Fonksiyonlar ve Sözlükler", "exercises": [
            {"msg": "**def:** Fonksiyon (tekrar eden kod paketi) tanımlamak için kullanılır.", "task": "___ pito(): pass", "check": lambda c, o, i: "def" in c, "solution": "def", "hint": "def yaz."},
        ...
        {"module_title": "8. Kalıcılık: Dosya Yönetimi", "exercises": [
            ...
            {"msg": "**.write():** Veriyi dosyaya mühürler.", "task": "f.___('X')", "check": lambda c, o, i: "write" in c, "solution": "write", "hint": "write."},
    ...
    if not is_review_mode and st.session_state.fail_count < 4 and not st.session_state.exercise_passed:
        ...
        # Ace Editor: auto_update=True yapılarak ve butona basılarak kontrol sağlanır.
