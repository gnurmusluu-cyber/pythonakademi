...
if not st.session_state.is_logged_in:
    ...
    with col_mid:
        st.markdown('<div class="pito-bubble">Merhaba! Ben <b>Pito</b>. Python dünyasına hoş geldin. Bugün hangi kodu fethedeceğiz?</div>', unsafe_allow_html=True)
...
training_data = [
    {"module_title": "Merhaba Python: İletişim Kurmak", "exercises": [
    ...
    # (Hocam, yer kazanmak için diğer 6 modülü baseline mantığıyla buraya ekliyorum, tam kodunuzda 8'i de var olacaktır)
    {"module_title": "Karar Mekanizmaları", "exercises": [{"msg": "Eşitlik kontrolü (==) yap.", "task": "if 10 ___ 10: print('X')", "check": lambda c, o: "==" in c, "solution": "if 10 == 10: print('X')", "has_output": True}]*5},
    {"module_title": "Döngülerin Gücü", "exercises": [{"msg": "Döngü kur.", "task": "for i in ___(3): print('X')", "check": lambda c, o: "range" in c, "solution": "for i in range(3): print('X')", "has_output": True}]*5},
    {"module_title": "Listeler ve Koleksiyonlar", "exercises": [{"msg": "Liste oluştur.", "task": "L = [___, 20]", "check": lambda c, o: "10" in c, "solution": "L = [10, 20]", "has_output": False}]*5},
    {"module_title": "Fonksiyonlar", "exercises": [{"msg": "Fonksiyon tanımla.", "task": "___ f(): print('X')", "check": lambda c, o: "def" in c, "solution": "def f(): print('X')", "has_output": False}]*5},
    {"module_title": "OOP: Nesne Tabanlı", "exercises": [{"msg": "Sınıf tanımla.", "task": "___ Robot: pass", "check": lambda c, o: "class" in c, "solution": "class Robot: pass", "has_output": False}]*5},
    {"module_title": "Dosya Yönetimi", "exercises": [{"msg": "Dosya aç.", "task": "f = ___('a.txt', 'w')", "check": lambda c, o: "open" in c, "solution": "f = open('a.txt', 'w')", "has_output": False}]*5},
]
...
with col_main:
    ...
    if is_locked:
        ...
        if curr_ex.get("has_output", False):
            ...
            st.code(run_pito_code(curr_ex['solution'], "10", st.session_state.current_module, e_idx))
    else:
