...
st.markdown("""
    ...
    iframe { border-radius: 15px !important; border: 2px solid #334155 !important; }
...
training_data = [
    {"module_title": "1. İletişim: print() ve Metin Dünyası", "exercises": [
        ...
        {"msg": "**# Yorum Satırı:** Diyez işareti Python'a 'Bu satırı görmezden gel' der. Sadece biz yazılımcıların kod içine not alması içindir; çalışmayı asla etkilemez.\n\n**GÖREV:** Satırın en başına **#** işaretini koy.", "task": "___ bu bir nottur", "check": lambda c, o, i: "#" in c, "solution": "# bu bir nottur", "hint": "Diyez (#) işaretini en başa yerleştir."},
...
with col_main:
    ...
    if sum(st.session_state.completed_modules) >= 8:
        ...
        st.markdown('<div class="pito-bubble" style="text-align:center;">🎊 <b>TEBRİKLER Python Kahramanı!</b><br>Nusaybin laboratuvarının gururusun. Python akademisini %100 mühürledin!</div>', unsafe_allow_html=True); st.balloons()
    ...
    # --- KOD KONTROL MERKEZİ (MÜHÜRLÜ SENKRONİZASYON) ---
    ...
    if not st.session_state.exercise_passed and st.session_state.fail_count < 4:
        # Editör key'ine hem adımı hem hata sayısını bağlıyoruz (Senkronizasyon Fix)
