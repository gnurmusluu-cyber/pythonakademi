...
training_data = [
    {"module_title": "1. Değişkenler: Hafıza Kutuları", "exercises": [
        {"msg": "**Pito'nun Notu:** Değişkenler, bilgisayarın hafızasındaki kutulardır. `=` işareti ile bu kutulara değer atarız.\n\n**Görev:** `yas` ismindeki değişkene (kutuya) **15** sayısal değerini atamanı istiyorum.", "task": "yas = ___", "check": lambda c, o, i: "15" in c, "solution": "yas = 15", "hint": "Boşluğa sadece 15 yazmalısın."},
        {"msg": "**Pito'nun Notu:** Metinleri (String) saklarken tırnak (' ') kullanırız.\n\n**Görev:** `isim` değişkenine tırnaklar içinde **'Pito'** değerini ata.", "task": "isim = ___", "check": lambda c, o, i: "'Pito'" in c or '"Pito"' in c, "solution": "isim = 'Pito'", "hint": "Boşluğa 'Pito' yazmalısın."},
        {"msg": "**Pito'nun Notu:** `print()` fonksiyonu parantez içindeki değeri ekrana yansıtır.\n\n**Görev:** Ekrana **'Merhaba'** yazdırmak için boşluğu doldur.", "task": "print('___')", "check": lambda c, o, i: "Merhaba" in o, "solution": "print('Merhaba')", "hint": "Boşluğa tam olarak Merhaba yaz."},
        {"msg": "**Pito'nun Notu:** Virgül (`,`) farklı tiplerdeki verileri birleştirir.\n\n**Görev:** 'Puan:' metninin yanına **100** sayısını eklemek için boşluğa 100 yaz.", "task": "print('Puan:', ___)", "check": lambda c, o, i: "100" in o, "solution": "print('Puan:', 100)", "hint": "Virgülden sonra 100 yaz."},
        {"msg": "**Pito'nun Notu:** `#` işareti bilgisayarın okumadığı, sadece bizim için olan notlardır.\n\n**Görev:** Satırın en başına **#** koyarak bu satırı yoruma dönüştür.", "task": "___ bu bir nottur", "check": lambda c, o, i: "#" in c, "solution": "# bu bir nottur", "hint": "Sadece diyez (#) işareti koy."}
    ]},
    {"module_title": "2. Karar Yapıları: Mantık Dünyası", "exercises": [
        {"msg": "**Pito'nun Notu:** `if` ile kontrol sağlarız. Eşitlik için `==` kullanılır.\n\n**Görev:** `s` 10'a eşitse 'OK' yazdıracak operatörü (**==**) boşluğa yaz.", "task": "s = 10\nif s ___ 10: print('OK')", "check": lambda c, o, i: "==" in c, "solution": "if s == 10:", "hint": "Çift eşittir kullan."},
        {"msg": "**Pito'nun Notu:** Şart sağlanmazsa `else:` bloğu devreye girer.\n\n**Görev:** Boşluğa **else** yazarak alternatif yolu tamamla.", "task": "if 5 > 10: pass\n___: print('Hata')", "check": lambda c, o, i: "else" in c, "solution": "else:", "hint": "Sadece else: yaz."},
        ...
        {"msg": "**Pito'nun Notu:** `and` her iki şartın da doğru olmasını bekler.\n\n**Görev:** Her iki şartın da doğru olduğunu kontrol etmek için boşluğa **and** yaz.", "task": "if 1==1 ___ 2==2: print('OK')", "check": lambda c, o, i: "and" in c, "solution": "and", "hint": "and bağlacını yaz."},
        {"msg": "**Pito'nun Notu:** `!=` eşit değilse demektir.\n\n**Görev:** `s` sıfır değilse 'Var' yazdıracak operatörü (**!=**) boşluğa koy.", "task": "s = 5\nif s ___ 0: print('Var')", "check": lambda c, o, i: "!=" in c, "solution": "if s != 0:", "hint": "!= operatörünü kullan."}
    ]},
    {"module_title": "3. Döngüler: Tekrar Otomasyonu", "exercises": [
        {"msg": "**Pito'nun Notu:** `for` döngüsü bir aralıkta (range) tekrar yapar.\n\n**Görev:** 5 kez dönecek bir döngü kurmak için boşluğa **range** yaz.", "task": "for i in ___(5): print(i)", "check": lambda c, o, i: "range" in c, "solution": "for i in range(5):", "hint": "range() yazmalısın."},
        {"msg": "**Pito'nun Notu:** `while` şart doğru olduğu sürece döner.\n\n**Görev:** Boşluğa **while** yazarak i sıfır oldukça sürecek döngüyü başlat.", "task": "i = 0\n___ i == 0: print('X'); i += 1", "check": lambda c, o, i: "while" in c, "solution": "while i == 0:", "hint": "while ile başlat."},
    ...
    {"module_title": "5. Fonksiyonlar: Özelleştirilmiş Komutlar", "exercises": [
        ...
        {"msg": "**Pito'nun Notu:** Fonksiyonlar isim ve parantez `()` ile çağrılır.\n\n**Görev:** Boşluğa **selam()** yazarak fonksiyonu çalıştır.", "task": "def selam(): print('X')\n___", "check": lambda c, o, i: "selam()" in c, "solution": "selam()", "hint": "Çağırma için parantez şart."},
        ...
        {"msg": "**Pito'nun Notu:** Karmaşıklığı azaltmak için def kullanılır.\n\n**Görev:** Boşluğa **def** yazarak süreci bitir.", "task": "___ son(): pass", "check": lambda c, o, i: "def" in c, "solution": "def son():", "hint": "def yaz."}
    ]},
    {"module_title": "6. Sözlükler: Anahtar ve Değer", "exercises": [
        {"msg": "**Pito'nun Notu:** **Sözlükler**, anahtar (key) ve değer (value) çiftlerini `{ }` içinde tutar. Örneğin bir etikete (key) bir veri (value) bağlarız.\n\n**Görev:** 'ad' anahtarına karşılık gelen değer boşluğuna tırnaklar içinde **'Pito'** yaz.", "task": "d = {'ad': '___'}\nprint(d['ad'])", "check": lambda c, o, i: "'Pito'" in c or '"Pito"' in c, "solution": "d = {'ad': 'Pito'}", "hint": "Pito yaz."},
        {"msg": "**Pito'nun Notu:** Sözlük değerine anahtarı köşeli parantez `[]` içinde yazarak ulaşırız.\n\n**Görev:** 'yas' değerini çekmek için boşluğa tırnaklar içinde **'yas'** yaz.", "task": "d = {'yas': 15}\nprint(d[___])", "check": lambda c, o, i: "'yas'" in c or '"yas"' in c, "solution": "d['yas']", "hint": "Anahtar ismi 'yas'."},
        {"msg": "**Pito'nun Notu:** `.keys()` tüm anahtarları (etiketleri) listeler.\n\n**Görev:** Boşluğa **keys** metodunu yaz.", "task": "d = {'a': 1}\nprint(d.___())", "check": lambda c, o, i: "keys" in c, "solution": "d.keys()", "hint": "keys yaz."},
        {"msg": "**Pito'nun Notu:** Tuple `()` ile kurulur ve değiştirilemez.\n\n**Görev:** Boşluğa sadece **1** yazarak demeti tamamla.", "task": "t = (___, 2)", "check": lambda c, o, i: "1" in c, "solution": "t = (1, 2)", "hint": "1 yaz."},
        {"msg": "**Pito'nun Notu:** Sözlükler karmaşık verileri etiketlemek için harikadır!\n\n**Görev:** Boşluğa **{}** yazarak boş bir sözlük kur.", "task": "d = ___", "check": lambda c, o, i: "{}" in c, "solution": "d = {}", "hint": "Süslü parantez koy."}
    ]},
    {"module_title": "7. OOP: Nesne ve Sınıf Mantığı", "exercises": [
        {"msg": "**Pito'nun Notu:** `class` bir kalıptır. Nesne ise o kalıptan çıkan üründür.\n\n**Görev:** 'Robot' kalıbı oluşturmak için boşluğa **class** yaz.", "task": "___ Robot: pass", "check": lambda c, o, i: "class" in c, "solution": "class Robot:", "hint": "Sınıf tanımlama kelimesi."},
    ...
    {"module_title": "8. Kalıcı Hafıza: Dosya İşlemleri", "exercises": [
        {"msg": "**Pito'nun Notu:** Dosya açmak için `open()` kullanılır. **'w'** yazma modudur.\n\n**Görev:** Dosyayı yazma modunda açmak için boşlukları **open** ve **'w'** ile doldur.", "task": "f = ___('n.txt', ___)", "check": lambda c, o, i: "open" in c and "'w'" in c, "solution": "open('n.txt', 'w')", "hint": "open ve 'w' kullan."},
        ...
        {"msg": "**Pito'nun Notu:** Okumak için **'r'** (read) modu kullanılır.\n\n**Görev:** Boşluğa tırnaklar içinde **'r'** yazarak okuma modunu ayarla.", "task": "f = open('t.txt', ___)", "check": lambda c, o, i: "'r'" in c, "solution": "f.open('t.txt', 'r')", "hint": "'r' yaz."},
