            ...
            if not user_data.empty:
                ...
                with c1:
                    if st.button("🚀 Devam Et"):
                        ...
                        # Selectbox Senkronu (Kesin Çözüm)
...
training_data = [
    {"module_title": "1. Giriş ve Çıktı", "exercises": [
        {"msg": "print() fonksiyonu ekrana çıktı vermemizi sağlar. Parantez içine metin yazarken tırnak kullanılır. Ekrana 'Merhaba Pito' yazdır.", "task": "print('___')", "check": lambda c, o: "Merhaba Pito" in o, "solution": "print('Merhaba Pito')"},
        ...
        {"msg": "print() içinde aralarına virgül koyarak birden fazla veriyi yan yana yazdırabilirsin. 'Puan:' ve 100 sayısını yan yana yazdır.", "task": "print('Puan:', ___)", "check": lambda c, o: "100" in o, "solution": "print('Puan:', 100)"},
        {"msg": "Kodlarımıza not eklemek için # işaretini kullanırız. Bilgisayar bu satırı okumaz. Bir yorum satırı oluştur.", "task": "___ Bu nottur", "check": lambda c, o: "#" in c, "solution": "# Bu bir nottur"},
        {"msg": "'\\n' karakteri bir alt satıra geçişi temsil eder. Üst ve Alt kelimelerini tek satırda ama farklı katlarda yazdır.", "task": "print('Üst' + '___' + 'Alt')", "check": lambda c, o: "\n" in o, "solution": "print('Üst' + '\\n' + 'Alt')"}
    ]},
    ...
    {"module_title": "3. Karar Yapıları", "exercises": [
        {"msg": "Eşitlik kontrolü için '==' kullanılır.", "task": "if 10 ___ 10: print('X')", "check": lambda c, o: "==" in c, "solution": "if 10 == 10: print('X')"},
        {"msg": "Büyük eşit kontrolü için '>=' kullanılır.", "task": "if 5 ___ 5: print('Z')", "check": lambda c, o: ">=" in c, "solution": "if 5 >= 5: print('Z')"},
        ...
        {"msg": "'elif' (else if) ile ek koşullar eklenir.", "task": "if 5>10: pass\n___ 5==5: print('A')", "check": lambda c, o: "elif" in c, "solution": "if 5>10: pass\nelif 5==5: print('A')"}
    ]},
    {"module_title": "4. Döngüler", "exercises": [
        {"msg": "3 kez dönen for döngüsü kur.", "task": "for i in ___(3): print('X')", "check": lambda c, o: o.count("X")==3, "solution": "for i in range(3): print('X')"},
        {"msg": "'while' ile sonsuz döngü tehlikesine dikkat ederek i<1 şartıyla başlat.", "task": "i=0\n___ i<1: print('Y'); i+=1", "check": lambda c, o: "while" in c, "solution": "i=0\nwhile i<1: print('Y'); i+=1"},
        {"msg": "'break' döngüyü aniden kırar ve çıkar.", "task": "for i in range(3):\n if i==1: ___\n print(i)", "check": lambda c, o: "break" in c, "solution": "for i in range(3):\n if i==1: break\n print(i)"},
        {"msg": "'continue' o adımı pas geçer.", "task": "for i in range(3):\n if i==1: ___\n print(i)", "check": lambda c, o: "continue" in c, "solution": "for i in range(3):\n if i==1: continue\n print(i)"},
        {"msg": "range(2) ile i sayacını yazdır.", "task": "for i in range(2): print(___)", "check": lambda c, o: "1" in o, "solution": "for i in range(2): print(i)"}
    ]},
    {"module_title": "5. Listeler", "exercises": [
        {"msg": "Listeler [] içinde birden fazla veri tutan kutulardır. [10, 20] oluştur.", "task": "L = [___, 20]", "check": lambda c, o: "10" in c, "solution": "L=[10, 20]\nprint(L)"},
    ...
    {"module_title": "6. Fonksiyonlar & Veri Yapıları", "exercises": [
        {"msg": "'def' ile fonksiyon tanımlanır.", "task": "___ f(): print('X')", "check": lambda c, o: "def" in c, "solution": "def f(): print('X')"},
        {"msg": "Tuple (1, 2) demeti oluştur. () kullanılır.", "task": "t = (___, 2)", "check": lambda c, o: "1" in c, "solution": "t = (1, 2)\nprint(t)"},
        {"msg": "Sözlükler 'key':'value' şeklinde çalışır. 'ad' anahtarına 'Pito' ata.", "task": "d = {'ad': '___'}", "check": lambda c, o: "Pito" in c, "solution": "d = {'ad': 'Pito'}\nprint(d['ad'])"},
        {"msg": "keys() sözlükteki tüm anahtar isimlerini verir.", "task": "d={'a':1}\nprint(d.___())", "check": lambda c, o: "keys" in c, "solution": "d={'a':1}\nprint(d.keys())"},
        {"msg": "set() tanımla {}. Benzersiz veri tutar.", "task": "s = {1, 2, ___}", "check": lambda c, o: "1" in c, "solution": "s = {1, 2, 1}"}
    ]},
    {"module_title": "7. OOP (Sınıflar)", "exercises": [
        {"msg": "Sınıf taslağı için 'class' anahtar kelimesi (küçük harf!) kullanılır.", "task": "___ Robot: pass", "check": lambda c, o: "class" in c, "solution": "class Robot: pass"},
        {"msg": "Sınıftan 'p' adında bir nesne üret.", "task": "class R: pass\np = ___()", "check": lambda c, o: "R()" in c, "solution": "class R: pass\np = R()"},
        {"msg": "Metotlar, sınıfa ait fonksiyonlardır ve mutlaka ilk parametreleri 'self' olmalıdır. Robota ses çıkartması için bir metot ekle.", "task": "class R:\n def ___(self):\n  print('Bip!')", "check": lambda c, o: "ses" in c, "solution": "class R:\n def ses(self):\n  print('Bip!')"},
        {"msg": "Niteliklere nesne adından sonra nokta koyarak erişilir.", "task": "class R: pass\np=R()\np.___ = 'Mavi'", "check": lambda c, o: "renk" in c, "solution": "class R: pass\np=R()\np.renk = 'Mavi'"},
        ...
        if e_idx < 4:
            ...
            if st.button("🏆 Modülü Bitir"):
                if st.session_state.current_module < 7:
                    ...
                    # Modül Bitir Senkronu
                    st.session_state[f"sel_{st.session_state.student_no}"] = f"{'✅' if st.session_state.completed_modules[st.session_state.current_module] else '📖'} Modül {st.session_state.current_module+1}"
                    st.balloons(); st.rerun()
                else:
                    st.success("Eğitimi Tamamladın! 🎓"); st.balloons()

with col_side:
    st.markdown(f"### 🏆 Liderler")
    df_lb = get_db()
