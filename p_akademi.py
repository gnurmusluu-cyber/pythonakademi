...
training_data = [
    {"module_title": "1. Giriş ve Çıktı", "exercises": [
        {"msg": "Programımızın dış dünyayla iletişim kurmasının en temel yolu **print()** fonksiyonudur. Parantez içine yazdığımız her şey terminal ekranında görünür. Metinsel ifadeleri mutlaka **tek veya çift tırnak** içinde yazmalısın. Hadi dene: Ekrana 'Merhaba Pito' yazdır.", "task": "print('___')", "check": lambda c, o: "Merhaba Pito" in o, "solution": "print('Merhaba Pito')"},
        {"msg": "Python'da sayılar metinlerden farklıdır. Matematiksel bir değer olan sayıları ekrana yazdırırken **tırnak işareti kullanmayız.** Bu sayede Python onların 'sayı' olduğunu anlar. Şimdi ekrana 100 sayısını yazdır.", "task": "print(___)", "check": lambda c, o: "100" in o, "solution": "print(100)"},
        {"msg": "Bazen bir cümleyi ve bir sayıyı yan yana yazdırmak isteriz. print() içinde farklı verileri ayırmak için **virgül (,)** kullanırız. Virgül, otomatik olarak araya bir boşluk bırakır. 'Puan:' metni ile 100 sayısını yan yana yazdır.", "task": "print('Puan:', ___)", "check": lambda c, o: "100" in o, "solution": "print('Puan:', 100)"},
        {"msg": "Kodlarımızın arasına kendimiz veya diğer yazılımcılar için notlar bırakmak isteriz. **# (Diyez)** işaretiyle başlayan satırlar Python tarafından okunmaz ve çalıştırılmaz. Buna 'Yorum Satırı' denir. Bir yorum satırı ekle.", "task": "___ Bu bir yorumdur", "check": lambda c, o: "#" in c, "solution": "# Bu bir yorumdur"},
        {"msg": "Metinlerin içinde bir alt satıra geçmek için özel bir karakter kullanırız: **'\\n'**. Bu karakter kodun içinde görünmez ama terminalde 'Enter' tuşuna basılmış gibi etki yaratır. Üst ve Alt kelimelerini tek print içinde farklı satırlarda yazdır.", "task": "print('Üst' + '___' + 'Alt')", "check": lambda c, o: "\n" in o, "solution": "print('Üst' + '\\n' + 'Alt')"}
    ]},
    {"module_title": "2. Değişkenler", "exercises": [{"msg": "Değişkenler bilgi saklayan kutulardır. yas = 15 tanımla.", "task": "yas = ___\nprint(yas)", "check": lambda c, o: "15" in o, "solution": "yas = 15\nprint(yas)"}, {"msg": "Metinler değişkenlerde tırnak içinde saklanır.", "task": "isim = '___'\nprint(isim)", "check": lambda c, o: "Pito" in o, "solution": "isim = 'Pito'\nprint(isim)"}, {"msg": "input() kullanıcıdan bilgi almamızı sağlar.", "task": "ad = ___('Adın: ')\nprint(ad)", "check": lambda c, o: "input" in c, "solution": "ad = input('Adın: ')\nprint(ad)"}, {"msg": "str() sayıları metne dönüştürür.", "task": "s = 10\nprint(___(s))", "check": lambda c, o: "str" in c, "solution": "s = 10\nprint(str(s))"}, {"msg": "int() ile girişi tam sayıya çevirmelisin.", "task": "n = ___(___('S: '))\nprint(n + 1)", "check": lambda c, o: "int" in c, "solution": "n = int(input('10'))\nprint(n + 1)"}]},
    {"module_title": "3. Karar Yapıları", "exercises": [{"msg": "== ile eşitlik kontrolü.", "task": "if 10 ___ 10: print('X')", "check": lambda c, o: "==" in c, "solution": "if 10 == 10: print('X')"}, {"msg": "'>=' büyük eşit kontrolü sağlar.", "task": "if 5 ___ 5: print('Z')", "check": lambda c, o: ">=" in c, "solution": "if 5 >= 5: print('Z')"}, {"msg": "else: yapısı koşul yanlışsa çalışır.", "task": "if 5>10: pass\n___: print('Y')", "check": lambda c, o: "else" in c, "solution": "if 5>10: pass\nelse: print('Y')"}, {"msg": "'and' ile iki koşulu bağla.", "task": "if 1==1 ___ 2==2: print('OK')", "check": lambda c, o: "and" in c, "solution": "if 1==1 and 2==2: print('OK')"}, {"msg": "'elif' ile ek koşul ekle.", "task": "if 5>10: pass\n___ 5==5: print('A')", "check": lambda c, o: "elif" in c, "solution": "if 5>10: pass\nelif 5==5: print('A')"}]},
    ...
    {"module_title": "5. Listeler", "exercises": [{"msg": "Listeler birden fazla veriyi saklar. [10, 20] oluştur.", "task": "L = [___, 20]", "check": lambda c, o: "10" in c, "solution": "L=[10, 20]\nprint(L)"}, {"msg": "Listenin 0. indeksine eriş.", "task": "L=[5,6]\nprint(L[___])", "check": lambda c, o: "5" in o, "solution": "L=[5,6]\nprint(L[0])"}, {"msg": "len() fonksiyonu boyut verir.", "task": "L=[1,2]\nprint(___(L))", "check": lambda c, o: "2" in o, "solution": "L=[1,2]\nprint(len(L))"}, {"msg": "append() ile listeye 30 ekle.", "task": "L=[10]\nL.___(___)\nprint(L)", "check": lambda c, o: "30" in o, "solution": "L=[10]\nL.append(30)\nprint(L)"}, {"msg": "pop() ile son elemanı sil.", "task": "L=[1,2]\nL.___()\nprint(L)", "check": lambda c, o: "1" in o, "solution": "L=[1,2]\nL.pop()\nprint(L)"}]},
    {"module_title": "6. Fonksiyonlar & Veri Yapıları", "exercises": [{"msg": "'def' ile fonksiyon tanımlanır.", "task": "___ f(): print('X')", "check": lambda c, o: "def" in c, "solution": "def f(): print('X')"}, {"msg": "Tuple (1, 2) demeti oluştur.", "task": "t = (___, 2)", "check": lambda c, o: "1" in c, "solution": "t = (1, 2)\nprint(t)"}, {"msg": "Sözlük 'ad':'Pito' ata.", "task": "d = {'ad': '___'}", "check": lambda c, o: "Pito" in c, "solution": "d = {'ad': 'Pito'}\nprint(d['ad'])"}, {"msg": "keys() anahtarları verir.", "task": "d={'a':1}\nprint(d.___())", "check": lambda c, o: "keys" in c, "solution": "d={'a':1}\nprint(d.keys())"}, {"msg": "set() benzersiz veri tutar.", "task": "s = {1, 2, ___}", "check": lambda c, o: "1" in c, "solution": "s = {1, 2, 1}"}]},
    {"module_title": "7. OOP", "exercises": [{"msg": "class (küçük harf!) ile sınıf oluştur.", "task": "___ Robot: pass", "check": lambda c, o: "class" in c, "solution": "class Robot: pass"}, {"msg": "Nesne üret.", "task": "class R: pass\np = ___()", "check": lambda c, o: "R()" in c, "solution": "class R: pass\np = R()"}, {"msg": "Nitelik ata.", "task": "class R: pass\np=R()\np.___ = 'Mavi'", "check": lambda c, o: "renk" in c, "solution": "class R: pass\np=R()\np.renk = 'Mavi'"}, {"msg": "Metot ekle. (self ekle!)", "task": "class R:\n def ___(self):\n  print('Bip')", "check": lambda c, o: "ses" in c, "solution": "class R:\n def ses(self):\n  print('Bip')"}, {"msg": "Metodu nesne üzerinden çağır.", "task": "class R: def s(self): print('X')\nr=R()\nr.___()", "check": lambda c, o: "s()" in c, "solution": "class R: def s(self): print('X')\nr=R()\nr.s()"}]},
    {"module_title": "8. Dosya İşlemleri", "exercises": [
        {"msg": "open() fonksiyonu kapıyı açar. 'w' (write) yazılabilir demektir.", "task": "dosya = ___('n.txt', '___')", "check": lambda c, o: "open" in c and "'w'" in c, "solution": "dosya = open('n.txt', 'w')\nprint('Açıldı.')"},
        {"msg": "write() metodu içeriğe yazar.", "task": "f = open('t.txt', 'w'); f.___('Pito'); f.close()", "check": lambda c, o: "write" in c, "solution": "f = open('t.txt', 'w'); f.write('Pito'); f.close()"},
        {"msg": "'r' (read) yalnızca okunabilir kipiyle aç.", "task": "f = open('t.txt', '___')", "check": lambda c, o: "'r'" in c, "solution": "f = open('t.txt', 'r'); f.close()"},
        {"msg": "read() içeriği bütünüyle getirir.", "task": "f = open('t.txt', 'r'); print(f.___()); f.close()", "check": lambda c, o: "read" in c, "solution": "f = open('t.txt', 'w'); f.write('Pito'); f.close(); f = open('t.txt', 'r'); print(f.read()); f.close()"},
        {"msg": "Mutlaka close() ile kapatmalısın.", "task": "f = open('t.txt', 'r'); f.___()", "check": lambda c, o: "close" in c, "solution": "f = open('t.txt', 'r'); f.close()"}
    ]}
]
...
with col_main:
    ...
    if st.session_state.db_module >= 8:
        ...
        with c1:
            if st.button("🔄 Eğitimi Tekrar Al (Sıfırla)"):
                ...
                force_save(); st.rerun()
        with c2:
            if st.button("🏆 Liderlik Listesinde Kal"): st.info("Puanın korundu.")
    ...
    # İNDEX TABANLI KONTROL (Hatayı önler)
            ...
            if e_idx < 4:
                ...
                if st.button("🏆 Modülü Bitir"):
                    if st.session_state.current_module < 7:
                        st.session_state.current_module += 1; st.session_state.current_exercise = 0; st.balloons(); st.rerun()
                    else: st.balloons(); st.rerun()
