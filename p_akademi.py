...
training_data = [
    {"module_title": "1. Giriş ve Çıktı", "exercises": [
        {"msg": "Python'da ekrana yazı yazdırmak için **print()** fonksiyonu kullanılır. Metinsel ifadeler mutlaka **tırnak** içinde olmalıdır.", "task": "print('___')", "check": lambda c, o: "Merhaba Pito" in o, "solution": "print('Merhaba Pito')"},
        {"msg": "Sayılar için tırnak gerekmez. Şimdi ekrana **100** sayısını yazdır.", "task": "print(___)", "check": lambda c, o: "100" in o, "solution": "print(100)"},
        ...
        {"msg": "Yorum satırı Python tarafından okunmaz ve **#** ile başlar.", "task": "___ Bu bir yorumdur", "check": lambda c, o: "#" in c, "solution": "# Not"},
    ...
    {"module_title": "3. Karar Yapıları", "exercises": [
        ...
        {"msg": "Şart yanlışsa **else:** bloğu çalışır.", "task": "if 5>10: pass\n___: print('Y')", "check": lambda c, o: "else" in c, "solution": "else"},
        {"msg": "Büyük veya eşittir için **>=** operatörünü kullan.", "task": "if 5 ___ 5: print('Z')", "check": lambda c, o: ">=" in c, "solution": ">="},
        {"msg": "**and** bağlacı her iki tarafın da doğru olmasını ister.", "task": "if 1==1 ___ 2==2: print('OK')", "check": lambda c, o: "and" in c, "solution": "and"},
        {"msg": "**elif** (else if) yapısı ile alternatif bir şart ekle.", "task": "if 5>10: pass\n___ 5==5: print('A')", "check": lambda c, o: "elif" in c, "solution": "elif"}
    ]},
    {"module_title": "4. Döngüler", "exercises": [
        {"msg": "3 kez tekrarlamak için **range(3)** kullan.", "task": "for i in ___(3): print('X')", "check": lambda c, o: o.count("X")==3, "solution": "range(3)"},
        {"msg": "**while** döngüsü yanındaki şart doğruyken çalışır.", "task": "i=0\n___ i<1: print('Y'); i+=1", "check": lambda c, o: "while" in c, "solution": "while"},
        {"msg": "**break** komutu döngüyü tamamen bitirir.", "task": "for i in range(3):\n if i==1: ___\n print(i)", "check": lambda c, o: "break" in c, "solution": "break"},
        {"msg": "**continue** o anki turu atlar, döngü sürer.", "task": "for i in range(3):\n if i==1: ___\n print(i)", "check": lambda c, o: "continue" in c, "solution": "continue"},
        {"msg": "Döngü sayacı olan **i** değişkenini yazdır.", "task": "for i in range(2): print(___)", "check": lambda c, o: "1" in o, "solution": "i"}
    ]},
    {"module_title": "5. Listeler", "exercises": [
        {"msg": "Liste oluştur: `[10, 20]`", "task": "L = [___, 20]", "check": lambda c, o: "10" in c, "solution": "L=[10, 20]"},
        {"msg": "İlk elemana erişmek için indeks 0 kullanılır.", "task": "L=[5,6]\nprint(L[___])", "check": lambda c, o: "5" in o, "solution": "0"},
        {"msg": "**len()** listenin kaç elemanlı olduğunu söyler.", "task": "L=[1,2]\nprint(___(L))", "check": lambda c, o: "2" in o, "solution": "len"},
        {"msg": "**append()** listenin sonuna yeni eleman ekler.", "task": "L=[10]\nL.___(___)\nprint(L)", "check": lambda c, o: "30" in o, "solution": "append"},
        {"msg": "**pop()** listeden sonuncuyu çıkarıp siler.", "task": "L=[1,2]\nL.___()\nprint(L)", "check": lambda c, o: "1" in o, "solution": "pop"}
    ]},
    {"module_title": "6. Fonksiyonlar ve Veriler", "exercises": [
        ...
        {"msg": "**Tuple (Demet)** bir kez kurulunca değişmez.", "task": "t = (___, 2)\nprint(t)", "check": lambda c, o: "1" in c, "solution": "1"},
        {"msg": "**Sözlükler** anahtar-değer ikilisiyle çalışır.", "task": "d = {'ad': '___'}\nprint(d['ad'])", "check": lambda c, o: "Pito" in o, "solution": "Pito"},
        {"msg": "**keys()** anahtarları getirir.", "task": "d={'a':1}\nprint(d.___())", "check": lambda c, o: "keys" in c, "solution": "keys"},
        {"msg": "**Set (Küme)** tekrar edenleri yok sayar.", "task": "s = {1, 2, ___}\nprint(s)", "check": lambda c, o: "1" in c, "solution": "1"}
    ]},
    {"module_title": "7. Nesne Tabanlı (OOP)", "exercises": [
        {"msg": "**class** ile bir taslak sınıf oluştur.", "task": "___ Robot: pass", "check": lambda c, o: "class" in c, "solution": "class Robot: pass"},
        {"msg": "Taslaktan gerçek bir nesne üret: `Robot()`", "task": "class R: pass\np = ___()", "check": lambda c, o: "R()" in c, "solution": "R()"},
        {"msg": "Nitelik atama: `p.renk = 'Mavi'`", "task": "class R: pass\np=R()\np.___ = 'Mavi'\nprint(p.renk)", "check": lambda c, o: "renk" in c, "solution": "renk"},
        {"msg": "Sınıf içi fonksiyona **Metot** denir ve `self` alır.", "task": "class R:\n def ___(self):\n  print('Bip!')", "check": lambda c, o: "ses" in c, "solution": "ses"},
        {"msg": "Metodu nesne üzerinden çağır.", "task": "class R:\n def s(self): print('X')\nr=R()\nr.___()", "check": lambda c, o: "s()" in c, "solution": "s()"}
    ]},
    {"module_title": "8. Dosya Yönetimi", "exercises": [
        {"msg": "**open()** ve **'w'** (write) kipiyle dosya aç.", "task": "dosya = ___('n.txt', '___')", "check": lambda c, o: "open" in c and "w" in c, "solution": "open('n.txt', 'w')"},
        {"msg": "**write()** dosyaya veri yazar.", "task": "f = open('t.txt', 'w'); f.___('Pito'); f.close()", "check": lambda c, o: "write" in c, "solution": "write"},
        {"msg": "**'r'** (read) kipi sadece okuma yapar.", "task": "f = open('t.txt', '___')", "check": lambda c, o: "r" in c, "solution": "r"},
        {"msg": "**read()** metnin tamamını getirir.", "task": "f = open('t.txt', 'r')\nprint(f.___())\nf.close()", "check": lambda c, o: "read" in c, "solution": "read"},
        {"msg": "**close()** hafızayı boşaltmak için dosyayı kapatır.", "task": "f = open('t.txt', 'r')\nf.___()", "check": lambda c, o: "close" in c, "solution": "close"}
    ]}
]
...
with col_main:
    ...
    sel_mod = st.selectbox("Modül Seç:", [f"{'✅' if st.session_state.completed_modules[i] else '📖'} Modül {i+1}: {training_data[i]['module_title']}" for i in range(8)], index=m_idx)
    new_m_idx = [i for i in range(8) if sel_mod.endswith(training_data[i]['module_title'])][0]
    ...
    def run_pito_code(c, user_input="Pito"):
        ...
        try:
            # Akıllı Mock Girdisi: int() varsa sayı gönder
    ...
    if is_locked:
        ...
        st.code(sol_out if sol_out else "11")
    else:
        ...
        if st.button("🔍 Kontrol Et", use_container_width=True):
            ...
            if out.startswith("⚠️") or out.startswith("❌"): st.error(out)
                ...
                if curr_ex['check'](code, out):
                    ...
                    st.warning("⚠️ Görev Tamamlanmadı: Kodun teknik olarak çalıştı ama Pito'nun istediği sonuç bu değil. Yönergeyi tekrar oku!")
                    st.code(out if out else "[Çıktı Boş]")
...
with col_side:
    ...
    with t1:
        ...
        for _, r in df_c.iterrows(): st.markdown(f'<div class="leaderboard-card"><b>{r["Rütbe"]} {r["Öğrencinin Adı"]}</b><br>{int(r["Puan"])} Puan</div>', unsafe_allow_html=True)
    with t2:
        df_s = df_lb.sort_values(by="Puan", ascending=False).head(10)
        for _, r in df_s.iterrows(): st.markdown(f'<div class="leaderboard-card"><b>{r["Rütbe"]} {r["Öğrencinin Adı"]} ({r["Sınıf"]})</b><br>{int(r["Puan"])} Puan</div>', unsafe_allow_html=True)